...
solver.Minimize( + (-10)*a_enob + (-10)*b_enob + (-10)*e_enob + (-10)*c_enob + (-10)*d_enob + (-10)*f_enob + (-10)*g_enob + (20)*C1_a_add + (20)*C2_a_add + (142.46)*C3_a_add + (95.1226)*C4_a_add + (144.835)*C5_a_add + (84.8013)*C6_a_add + (27.1682)*C7_a_add + (24.497)*C8_a_add + (20)*C1_b_add + (20)*C2_b_add + (142.46)*C3_b_add + (95.1226)*C4_b_add + (144.835)*C5_b_add + (84.8013)*C6_b_add + (27.1682)*C7_b_add + (24.497)*C8_b_add + (-10)*main_add_enob + (29.3322)*main_add_fixp + (27.7684)*main_add_float + (56.7202)*main_add_double + (20)*C1_main_add_ + (20)*C2_main_add_ + (142.46)*C3_main_add_ + (95.1226)*C4_main_add_ + (144.835)*C5_main_add_ + (84.8013)*C6_main_add_ + (27.1682)*C7_main_add_ + (24.497)*C8_main_add_ + (20)*C1_c_add1 + (20)*C2_c_add1 + (142.46)*C3_c_add1 + (95.1226)*C4_c_add1 + (144.835)*C5_c_add1 + (84.8013)*C6_c_add1 + (27.1682)*C7_c_add1 + (24.497)*C8_c_add1 + (20)*C1_d_add1 + (20)*C2_d_add1 + (142.46)*C3_d_add1 + (95.1226)*C4_d_add1 + (144.835)*C5_d_add1 + (84.8013)*C6_d_add1 + (27.1682)*C7_d_add1 + (24.497)*C8_d_add1 + (-10)*main_add1_enob + (29.3322)*main_add1_fixp + (27.7684)*main_add1_float + (56.7202)*main_add1_double + (20)*C1_main_add1_ + (20)*C2_main_add1_ + (142.46)*C3_main_add1_ + (95.1226)*C4_main_add1_ + (144.835)*C5_main_add1_ + (84.8013)*C6_main_add1_ + (27.1682)*C7_main_add1_ + (24.497)*C8_main_add1_ + (20)*C1_f_mul + (20)*C2_f_mul + (142.46)*C3_f_mul + (95.1226)*C4_f_mul + (144.835)*C5_f_mul + (84.8013)*C6_f_mul + (27.1682)*C7_f_mul + (24.497)*C8_f_mul + (20)*C1_e_mul + (20)*C2_e_mul + (142.46)*C3_e_mul + (95.1226)*C4_e_mul + (144.835)*C5_e_mul + (84.8013)*C6_e_mul + (27.1682)*C7_e_mul + (24.497)*C8_e_mul + (-10)*main_mul_enob + (29.4336)*main_mul_fixp + (76.7709)*main_mul_float + (57.6839)*main_mul_double + (20)*C1_main_mul_ + (20)*C2_main_mul_ + (142.46)*C3_main_mul_ + (95.1226)*C4_main_mul_ + (144.835)*C5_main_mul_ + (84.8013)*C6_main_mul_ + (27.1682)*C7_main_mul_ + (24.497)*C8_main_mul_)
