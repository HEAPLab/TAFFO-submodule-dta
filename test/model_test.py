...
#Constraint for cast for   store double 1.000000e+00, double* %arrayidx15, align 8, !taffo.info !32, !taffo.initweight !22, !taffo.constinfo !33
...
castCostObj +=  + (1.65783)*C7_ConstantValue__0_CAST_store
...
castCostObj +=  + (1.81502)*C8_ConstantValue__0_CAST_store
...
#Constraint for cast for   %mul = fmul double %tmp, %tmp1, !taffo.info !42, !taffo.initweight !26
...
mathCostObj =  + (1.54355)*main_mul_fixp
mathCostObj +=  + (1.63352)*main_mul_float
mathCostObj +=  + (3.54145)*main_mul_double
...
#Constraint for cast for   %add60 = fadd double %tmp2, %mul, !taffo.info !43, !taffo.initweight !26
...
mathCostObj +=  + (1.27539)*main_add60_fixp
mathCostObj +=  + (1.63346)*main_add60_float
mathCostObj +=  + (2.80473)*main_add60_double
...
#Constraint for cast for   %mul68 = fmul double 1.500000e+00, %tmp3, !taffo.info !47, !taffo.initweight !21, !taffo.constinfo !49
...
castCostObj +=  + (1.65783)*C7_ConstantValue__3_CAST_mul68
...
castCostObj +=  + (1.81502)*C8_ConstantValue__3_CAST_mul68
...
mathCostObj +=  + (1.54355)*main_mul68_fixp
mathCostObj +=  + (1.63352)*main_mul68_float
mathCostObj +=  + (3.54145)*main_mul68_double
...
#Constraint for cast for   store double %mul68, double* %arrayidx72, align 8, !taffo.info !32, !taffo.initweight !22
...
#Constraint for cast for   %call96 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %tmp5, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.6, i32 0, i32 0), double %tmp6), !taffo.info !15, !taffo.initweight !26, !taffo.constinfo !55
...
solver.Minimize(10000 * castCostObj / 204.547+ 1 * enobCostObj / 1665+ 10000 * mathCostObj / 9.88764)
