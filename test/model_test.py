...
#Stuff for   %conv = sitofp i32 %mul to double, !taffo.info !28, !taffo.initweight !30
...
#Constraint for cast for   %div = fdiv double %conv, 3.200000e+01, !taffo.info !34, !taffo.initweight !36, !taffo.constinfo !37
...
#Stuff for double 3.200000e+01
ConstantValue__1_fixbits = solver.IntVar(0, 26, 'ConstantValue__1_fixbits')
...
solver.Add( + (1)*ConstantValue__1_enob + (10000)*ConstantValue__1_float<=10018)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__1_enob + (10000)*ConstantValue__1_double<=10047)    #Enob constraint for double
solver.Add( + (1)*ConstantValue__1_fixbits + (-10000)*ConstantValue__1_fixp>=-9975)    #Limit the lower number of frac bits26
...
#Constraint for cast for   %div = fdiv double %conv, 3.200000e+01, !taffo.info !34, !taffo.initweight !36, !taffo.constinfo !37
ConstantValue__1_CAST_div_fixbits = solver.IntVar(0, 26, 'ConstantValue__1_CAST_div_fixbits')
...
#Stuff for   %conv12 = sitofp i32 %i.0 to double, !taffo.info !28, !taffo.initweight !29
main_conv12_fixbits = solver.IntVar(0, 27, 'main_conv12_fixbits')
...
solver.Add( + (1)*main_conv12_fixbits + (-10000)*main_conv12_fixp>=-9974)    #Limit the lower number of frac bits27
...
#Constraint for cast for   %add = fadd double %div, %conv12, !taffo.info !40, !taffo.initweight !30
main_div_CAST_add_fixbits = solver.IntVar(0, 31, 'main_div_CAST_add_fixbits')
...
castCostObj +=  + (6.64554)*C3_main_div_CAST_add
solver.Add( + (1)*main_div_float + (1)*main_div_CAST_add_fixp + (-1)*C4_main_div_CAST_add<=1)    #Float to fix
castCostObj +=  + (4.527)*C4_main_div_CAST_add
solver.Add( + (1)*main_div_fixp + (1)*main_div_CAST_add_double + (-1)*C5_main_div_CAST_add<=1)    #Fix to double
castCostObj +=  + (7.54108)*C5_main_div_CAST_add
solver.Add( + (1)*main_div_double + (1)*main_div_CAST_add_fixp + (-1)*C6_main_div_CAST_add<=1)    #Double to fix
castCostObj +=  + (3.31338)*C6_main_div_CAST_add
solver.Add( + (1)*main_div_float + (1)*main_div_CAST_add_double + (-1)*C7_main_div_CAST_add<=1)    #Float to double
castCostObj +=  + (1.69718)*C7_main_div_CAST_add
solver.Add( + (1)*main_div_double + (1)*main_div_CAST_add_float + (-1)*C8_main_div_CAST_add<=1)    #Double to float
castCostObj +=  + (1.39671)*C8_main_div_CAST_add



#Constraint for cast for   %add = fadd double %div, %conv12, !taffo.info !40, !taffo.initweight !30
main_conv12_CAST_add_fixbits = solver.IntVar(0, 27, 'main_conv12_CAST_add_fixbits')
main_conv12_CAST_add_fixp = solver.IntVar(0, 1, 'main_conv12_CAST_add_fixp')
main_conv12_CAST_add_float = solver.IntVar(0, 1, 'main_conv12_CAST_add_float')
main_conv12_CAST_add_double = solver.IntVar(0, 1, 'main_conv12_CAST_add_double')
solver.Add( + (1)*main_conv12_CAST_add_fixp + (1)*main_conv12_CAST_add_float + (1)*main_conv12_CAST_add_double==1)    #exactly 1 type
solver.Add( + (1)*main_conv12_CAST_add_fixbits + (-10000)*main_conv12_CAST_add_fixp<=0)    #If no fix, fix frac part = 0
C1_main_conv12_CAST_add = solver.IntVar(0, 1, 'C1_main_conv12_CAST_add')
C2_main_conv12_CAST_add = solver.IntVar(0, 1, 'C2_main_conv12_CAST_add')
solver.Add( + (1)*main_conv12_fixbits + (-1)*main_conv12_CAST_add_fixbits + (-10000)*C1_main_conv12_CAST_add<=0)    #Shift cost 1
solver.Add( + (-1)*main_conv12_fixbits + (1)*main_conv12_CAST_add_fixbits + (-10000)*C2_main_conv12_CAST_add<=0)    #Shift cost 2
castCostObj +=  + (1)*C1_main_conv12_CAST_add
castCostObj +=  + (1)*C2_main_conv12_CAST_add
C3_main_conv12_CAST_add = solver.IntVar(0, 1, 'C3_main_conv12_CAST_add')
C4_main_conv12_CAST_add = solver.IntVar(0, 1, 'C4_main_conv12_CAST_add')
C5_main_conv12_CAST_add = solver.IntVar(0, 1, 'C5_main_conv12_CAST_add')
C6_main_conv12_CAST_add = solver.IntVar(0, 1, 'C6_main_conv12_CAST_add')
C7_main_conv12_CAST_add = solver.IntVar(0, 1, 'C7_main_conv12_CAST_add')
C8_main_conv12_CAST_add = solver.IntVar(0, 1, 'C8_main_conv12_CAST_add')
solver.Add( + (1)*main_conv12_fixp + (1)*main_conv12_CAST_add_float + (-1)*C3_main_conv12_CAST_add<=1)    #Fix to float
castCostObj +=  + (6.64554)*C3_main_conv12_CAST_add
solver.Add( + (1)*main_conv12_float + (1)*main_conv12_CAST_add_fixp + (-1)*C4_main_conv12_CAST_add<=1)    #Float to fix
castCostObj +=  + (4.527)*C4_main_conv12_CAST_add
solver.Add( + (1)*main_conv12_fixp + (1)*main_conv12_CAST_add_double + (-1)*C5_main_conv12_CAST_add<=1)    #Fix to double
castCostObj +=  + (7.54108)*C5_main_conv12_CAST_add
solver.Add( + (1)*main_conv12_double + (1)*main_conv12_CAST_add_fixp + (-1)*C6_main_conv12_CAST_add<=1)    #Double to fix
castCostObj +=  + (3.31338)*C6_main_conv12_CAST_add
solver.Add( + (1)*main_conv12_float + (1)*main_conv12_CAST_add_double + (-1)*C7_main_conv12_CAST_add<=1)    #Float to double
castCostObj +=  + (1.69718)*C7_main_conv12_CAST_add
solver.Add( + (1)*main_conv12_double + (1)*main_conv12_CAST_add_float + (-1)*C8_main_conv12_CAST_add<=1)    #Double to float
castCostObj +=  + (1.39671)*C8_main_conv12_CAST_add



#Stuff for   %add = fadd double %div, %conv12, !taffo.info !40, !taffo.initweight !30
main_add_fixbits = solver.IntVar(0, 27, 'main_add_fixbits')
...
solver.Add( + (1)*main_add_fixbits + (-10000)*main_add_fixp>=-9974)    #Limit the lower number of frac bits27
...
solver.Add( + (1)*main_div_CAST_add_fixp + (-1)*main_conv12_CAST_add_fixp==0)    #fix equality
solver.Add( + (1)*main_div_CAST_add_float + (-1)*main_conv12_CAST_add_float==0)    #float equality
solver.Add( + (1)*main_div_CAST_add_double + (-1)*main_conv12_CAST_add_double==0)    #double equality
solver.Add( + (1)*main_div_CAST_add_fixbits + (-1)*main_conv12_CAST_add_fixbits==0)    #same fractional bit
...
mathCostObj +=  + (1.43251)*main_add_fixp
mathCostObj +=  + (1.47242)*main_add_float
mathCostObj +=  + (2.6385)*main_add_double
solver.Add( + (1)*main_add_enob + (-1)*main_div_enob<=0)    #Enob propagation in sum first addend
solver.Add( + (1)*main_add_enob + (-1)*main_conv12_enob<=0)    #Enob propagation in sum second addend
...
#Stuff for double 2.800000e+01
ConstantValue__3_fixbits = solver.IntVar(0, 27, 'ConstantValue__3_fixbits')
...
solver.Add( + (1)*ConstantValue__3_enob + (10000)*ConstantValue__3_float<=10019)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__3_enob + (10000)*ConstantValue__3_double<=10048)    #Enob constraint for double
solver.Add( + (1)*ConstantValue__3_fixbits + (-10000)*ConstantValue__3_fixp>=-9974)    #Limit the lower number of frac bits27
...
#Constraint for cast for   %div13 = fdiv double %add, 2.800000e+01, !taffo.info !42, !taffo.initweight !36, !taffo.constinfo !44
main_add_CAST_div13_fixbits = solver.IntVar(0, 27, 'main_add_CAST_div13_fixbits')
main_add_CAST_div13_fixp = solver.IntVar(0, 1, 'main_add_CAST_div13_fixp')
main_add_CAST_div13_float = solver.IntVar(0, 1, 'main_add_CAST_div13_float')
main_add_CAST_div13_double = solver.IntVar(0, 1, 'main_add_CAST_div13_double')
solver.Add( + (1)*main_add_CAST_div13_fixp + (1)*main_add_CAST_div13_float + (1)*main_add_CAST_div13_double==1)    #exactly 1 type
solver.Add( + (1)*main_add_CAST_div13_fixbits + (-10000)*main_add_CAST_div13_fixp<=0)    #If no fix, fix frac part = 0
C1_main_add_CAST_div13 = solver.IntVar(0, 1, 'C1_main_add_CAST_div13')
C2_main_add_CAST_div13 = solver.IntVar(0, 1, 'C2_main_add_CAST_div13')
solver.Add( + (1)*main_add_fixbits + (-1)*main_add_CAST_div13_fixbits + (-10000)*C1_main_add_CAST_div13<=0)    #Shift cost 1
solver.Add( + (-1)*main_add_fixbits + (1)*main_add_CAST_div13_fixbits + (-10000)*C2_main_add_CAST_div13<=0)    #Shift cost 2
castCostObj +=  + (1)*C1_main_add_CAST_div13
castCostObj +=  + (1)*C2_main_add_CAST_div13
C3_main_add_CAST_div13 = solver.IntVar(0, 1, 'C3_main_add_CAST_div13')
C4_main_add_CAST_div13 = solver.IntVar(0, 1, 'C4_main_add_CAST_div13')
C5_main_add_CAST_div13 = solver.IntVar(0, 1, 'C5_main_add_CAST_div13')
C6_main_add_CAST_div13 = solver.IntVar(0, 1, 'C6_main_add_CAST_div13')
C7_main_add_CAST_div13 = solver.IntVar(0, 1, 'C7_main_add_CAST_div13')
C8_main_add_CAST_div13 = solver.IntVar(0, 1, 'C8_main_add_CAST_div13')
solver.Add( + (1)*main_add_fixp + (1)*main_add_CAST_div13_float + (-1)*C3_main_add_CAST_div13<=1)    #Fix to float
castCostObj +=  + (6.64554)*C3_main_add_CAST_div13
solver.Add( + (1)*main_add_float + (1)*main_add_CAST_div13_fixp + (-1)*C4_main_add_CAST_div13<=1)    #Float to fix
castCostObj +=  + (4.527)*C4_main_add_CAST_div13
solver.Add( + (1)*main_add_fixp + (1)*main_add_CAST_div13_double + (-1)*C5_main_add_CAST_div13<=1)    #Fix to double
castCostObj +=  + (7.54108)*C5_main_add_CAST_div13
solver.Add( + (1)*main_add_double + (1)*main_add_CAST_div13_fixp + (-1)*C6_main_add_CAST_div13<=1)    #Double to fix
castCostObj +=  + (3.31338)*C6_main_add_CAST_div13
solver.Add( + (1)*main_add_float + (1)*main_add_CAST_div13_double + (-1)*C7_main_add_CAST_div13<=1)    #Float to double
castCostObj +=  + (1.69718)*C7_main_add_CAST_div13
solver.Add( + (1)*main_add_double + (1)*main_add_CAST_div13_float + (-1)*C8_main_add_CAST_div13<=1)    #Double to float
castCostObj +=  + (1.39671)*C8_main_add_CAST_div13



#Stuff for double 2.800000e+01
ConstantValue__4_fixbits = solver.IntVar(0, 27, 'ConstantValue__4_fixbits')
...
solver.Add( + (1)*ConstantValue__4_enob + (10000)*ConstantValue__4_float<=10019)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__4_enob + (10000)*ConstantValue__4_double<=10048)    #Enob constraint for double
solver.Add( + (1)*ConstantValue__4_fixbits + (-10000)*ConstantValue__4_fixp>=-9974)    #Limit the lower number of frac bits27
...
#Constraint for cast for   %div13 = fdiv double %add, 2.800000e+01, !taffo.info !42, !taffo.initweight !36, !taffo.constinfo !44
ConstantValue__4_CAST_div13_fixbits = solver.IntVar(0, 27, 'ConstantValue__4_CAST_div13_fixbits')
ConstantValue__4_CAST_div13_fixp = solver.IntVar(0, 1, 'ConstantValue__4_CAST_div13_fixp')
ConstantValue__4_CAST_div13_float = solver.IntVar(0, 1, 'ConstantValue__4_CAST_div13_float')
ConstantValue__4_CAST_div13_double = solver.IntVar(0, 1, 'ConstantValue__4_CAST_div13_double')
solver.Add( + (1)*ConstantValue__4_CAST_div13_fixp + (1)*ConstantValue__4_CAST_div13_float + (1)*ConstantValue__4_CAST_div13_double==1)    #exactly 1 type
solver.Add( + (1)*ConstantValue__4_CAST_div13_fixbits + (-10000)*ConstantValue__4_CAST_div13_fixp<=0)    #If no fix, fix frac part = 0
C1_ConstantValue__4_CAST_div13 = solver.IntVar(0, 1, 'C1_ConstantValue__4_CAST_div13')
C2_ConstantValue__4_CAST_div13 = solver.IntVar(0, 1, 'C2_ConstantValue__4_CAST_div13')
solver.Add( + (1)*ConstantValue__4_fixbits + (-1)*ConstantValue__4_CAST_div13_fixbits + (-10000)*C1_ConstantValue__4_CAST_div13<=0)    #Shift cost 1
solver.Add( + (-1)*ConstantValue__4_fixbits + (1)*ConstantValue__4_CAST_div13_fixbits + (-10000)*C2_ConstantValue__4_CAST_div13<=0)    #Shift cost 2
castCostObj +=  + (1)*C1_ConstantValue__4_CAST_div13
castCostObj +=  + (1)*C2_ConstantValue__4_CAST_div13
C3_ConstantValue__4_CAST_div13 = solver.IntVar(0, 1, 'C3_ConstantValue__4_CAST_div13')
C4_ConstantValue__4_CAST_div13 = solver.IntVar(0, 1, 'C4_ConstantValue__4_CAST_div13')
C5_ConstantValue__4_CAST_div13 = solver.IntVar(0, 1, 'C5_ConstantValue__4_CAST_div13')
C6_ConstantValue__4_CAST_div13 = solver.IntVar(0, 1, 'C6_ConstantValue__4_CAST_div13')
C7_ConstantValue__4_CAST_div13 = solver.IntVar(0, 1, 'C7_ConstantValue__4_CAST_div13')
C8_ConstantValue__4_CAST_div13 = solver.IntVar(0, 1, 'C8_ConstantValue__4_CAST_div13')
solver.Add( + (1)*ConstantValue__4_fixp + (1)*ConstantValue__4_CAST_div13_float + (-1)*C3_ConstantValue__4_CAST_div13<=1)    #Fix to float
castCostObj +=  + (6.64554)*C3_ConstantValue__4_CAST_div13
solver.Add( + (1)*ConstantValue__4_float + (1)*ConstantValue__4_CAST_div13_fixp + (-1)*C4_ConstantValue__4_CAST_div13<=1)    #Float to fix
castCostObj +=  + (4.527)*C4_ConstantValue__4_CAST_div13
solver.Add( + (1)*ConstantValue__4_fixp + (1)*ConstantValue__4_CAST_div13_double + (-1)*C5_ConstantValue__4_CAST_div13<=1)    #Fix to double
castCostObj +=  + (7.54108)*C5_ConstantValue__4_CAST_div13
solver.Add( + (1)*ConstantValue__4_double + (1)*ConstantValue__4_CAST_div13_fixp + (-1)*C6_ConstantValue__4_CAST_div13<=1)    #Double to fix
castCostObj +=  + (3.31338)*C6_ConstantValue__4_CAST_div13
solver.Add( + (1)*ConstantValue__4_float + (1)*ConstantValue__4_CAST_div13_double + (-1)*C7_ConstantValue__4_CAST_div13<=1)    #Float to double
castCostObj +=  + (1.69718)*C7_ConstantValue__4_CAST_div13
solver.Add( + (1)*ConstantValue__4_double + (1)*ConstantValue__4_CAST_div13_float + (-1)*C8_ConstantValue__4_CAST_div13<=1)    #Double to float
castCostObj +=  + (1.39671)*C8_ConstantValue__4_CAST_div13



#Stuff for   %div13 = fdiv double %add, 2.800000e+01, !taffo.info !42, !taffo.initweight !36, !taffo.constinfo !44
main_div13_fixbits = solver.IntVar(0, 30, 'main_div13_fixbits')
main_div13_fixp = solver.IntVar(0, 1, 'main_div13_fixp')
main_div13_float = solver.IntVar(0, 1, 'main_div13_float')
main_div13_double = solver.IntVar(0, 1, 'main_div13_double')
main_div13_enob = solver.IntVar(-10000, 10000, 'main_div13_enob')
solver.Add( + (1)*main_div13_enob + (-1)*main_div13_fixbits + (10000)*main_div13_fixp<=10000)    #Enob constraint for fix
solver.Add( + (1)*main_div13_enob + (10000)*main_div13_float<=10149)    #Enob constraint for float
solver.Add( + (1)*main_div13_enob + (10000)*main_div13_double<=11074)    #Enob constraint for double
solver.Add( + (1)*main_div13_fixbits + (-10000)*main_div13_fixp>=-9971)    #Limit the lower number of frac bits30
enobCostObj +=  + (-1)*main_div13_enob
solver.Add( + (1)*main_div13_fixp + (1)*main_div13_float + (1)*main_div13_double==1)    #Exactly one selected type
solver.Add( + (1)*main_div13_fixbits + (-10000)*main_div13_fixp<=0)    #If not fix, frac part to zero
solver.Add( + (1)*main_add_CAST_div13_fixp + (-1)*ConstantValue__4_CAST_div13_fixp==0)    #fix equality
solver.Add( + (1)*main_add_CAST_div13_float + (-1)*ConstantValue__4_CAST_div13_float==0)    #float equality
solver.Add( + (1)*main_add_CAST_div13_double + (-1)*ConstantValue__4_CAST_div13_double==0)    #double equality
solver.Add( + (1)*main_add_CAST_div13_fixp + (-1)*main_div13_fixp==0)    #fix equality
solver.Add( + (1)*main_add_CAST_div13_float + (-1)*main_div13_float==0)    #float equality
solver.Add( + (1)*main_add_CAST_div13_double + (-1)*main_div13_double==0)    #double equality
mathCostObj +=  + (13.2477)*main_div13_fixp
mathCostObj +=  + (6.64202)*main_div13_float
mathCostObj +=  + (7.0892)*main_div13_double
main_main_div13_enob_1 = solver.IntVar(0, 1, 'main_main_div13_enob_1')
main_main_div13_enob_2 = solver.IntVar(0, 1, 'main_main_div13_enob_2')
solver.Add( + (1)*main_main_div13_enob_1 + (1)*main_main_div13_enob_2==1)    #Enob: one selected constraint
solver.Add( + (1)*main_div13_enob + (-1)*ConstantValue__2_enob + (-10000)*main_main_div13_enob_1<=1034)    #Enob: propagation in division 1
solver.Add( + (1)*main_div13_enob + (-1)*main_add_enob + (-10000)*main_main_div13_enob_2<=5)    #Enob: propagation in division 2



#Constraint for cast for   store double %div13, double* %arrayidx15, align 8, !taffo.info !17, !taffo.initweight !30
main_div13_CAST_store_fixbits = solver.IntVar(0, 30, 'main_div13_CAST_store_fixbits')
main_div13_CAST_store_fixp = solver.IntVar(0, 1, 'main_div13_CAST_store_fixp')
main_div13_CAST_store_float = solver.IntVar(0, 1, 'main_div13_CAST_store_float')
main_div13_CAST_store_double = solver.IntVar(0, 1, 'main_div13_CAST_store_double')
solver.Add( + (1)*main_div13_CAST_store_fixp + (1)*main_div13_CAST_store_float + (1)*main_div13_CAST_store_double==1)    #exactly 1 type
solver.Add( + (1)*main_div13_CAST_store_fixbits + (-10000)*main_div13_CAST_store_fixp<=0)    #If no fix, fix frac part = 0
C1_main_div13_CAST_store = solver.IntVar(0, 1, 'C1_main_div13_CAST_store')
C2_main_div13_CAST_store = solver.IntVar(0, 1, 'C2_main_div13_CAST_store')
solver.Add( + (1)*main_div13_fixbits + (-1)*main_div13_CAST_store_fixbits + (-10000)*C1_main_div13_CAST_store<=0)    #Shift cost 1
solver.Add( + (-1)*main_div13_fixbits + (1)*main_div13_CAST_store_fixbits + (-10000)*C2_main_div13_CAST_store<=0)    #Shift cost 2
castCostObj +=  + (1)*C1_main_div13_CAST_store
castCostObj +=  + (1)*C2_main_div13_CAST_store
C3_main_div13_CAST_store = solver.IntVar(0, 1, 'C3_main_div13_CAST_store')
C4_main_div13_CAST_store = solver.IntVar(0, 1, 'C4_main_div13_CAST_store')
C5_main_div13_CAST_store = solver.IntVar(0, 1, 'C5_main_div13_CAST_store')
C6_main_div13_CAST_store = solver.IntVar(0, 1, 'C6_main_div13_CAST_store')
C7_main_div13_CAST_store = solver.IntVar(0, 1, 'C7_main_div13_CAST_store')
C8_main_div13_CAST_store = solver.IntVar(0, 1, 'C8_main_div13_CAST_store')
solver.Add( + (1)*main_div13_fixp + (1)*main_div13_CAST_store_float + (-1)*C3_main_div13_CAST_store<=1)    #Fix to float
castCostObj +=  + (6.64554)*C3_main_div13_CAST_store
solver.Add( + (1)*main_div13_float + (1)*main_div13_CAST_store_fixp + (-1)*C4_main_div13_CAST_store<=1)    #Float to fix
castCostObj +=  + (4.527)*C4_main_div13_CAST_store
solver.Add( + (1)*main_div13_fixp + (1)*main_div13_CAST_store_double + (-1)*C5_main_div13_CAST_store<=1)    #Fix to double
castCostObj +=  + (7.54108)*C5_main_div13_CAST_store
solver.Add( + (1)*main_div13_double + (1)*main_div13_CAST_store_fixp + (-1)*C6_main_div13_CAST_store<=1)    #Double to fix
castCostObj +=  + (3.31338)*C6_main_div13_CAST_store
solver.Add( + (1)*main_div13_float + (1)*main_div13_CAST_store_double + (-1)*C7_main_div13_CAST_store<=1)    #Float to double
castCostObj +=  + (1.69718)*C7_main_div13_CAST_store
solver.Add( + (1)*main_div13_double + (1)*main_div13_CAST_store_float + (-1)*C8_main_div13_CAST_store<=1)    #Double to float
castCostObj +=  + (1.39671)*C8_main_div13_CAST_store
solver.Add( + (1)*main_data_fixp + (-1)*main_div13_CAST_store_fixp==0)    #fix equality
solver.Add( + (1)*main_data_float + (-1)*main_div13_CAST_store_float==0)    #float equality
solver.Add( + (1)*main_data_double + (-1)*main_div13_CAST_store_double==0)    #double equality
solver.Add( + (1)*main_data_fixbits + (-1)*main_div13_CAST_store_fixbits==0)    #same fractional bit
...
solver.Add( + (1)*main_data_enob_storeENOB + (-1)*main_div13_enob<=0)    #Enob constraint ENOB propagation in load/store
...
#Constraint for cast for   store double 0.000000e+00, double* %arrayidx25, align 8, !taffo.info !13, !taffo.initweight !29, !taffo.constinfo !48
...
castCostObj +=  + (1.69718)*C7_ConstantValue__6_CAST_store
...
castCostObj +=  + (1.39671)*C8_ConstantValue__6_CAST_store
solver.Add( + (1)*main_mean_fixp + (-1)*ConstantValue__6_CAST_store_fixp==0)    #fix equality
solver.Add( + (1)*main_mean_float + (-1)*ConstantValue__6_CAST_store_float==0)    #float equality
solver.Add( + (1)*main_mean_double + (-1)*ConstantValue__6_CAST_store_double==0)    #double equality
solver.Add( + (1)*main_mean_fixbits + (-1)*ConstantValue__6_CAST_store_fixbits==0)    #same fractional bit
...
solver.Add( + (1)*main_data_enob_memphi_main_tmp + (-1)*main_data_enob_storeENOB + (10000)*main_main_tmp_enob_1<=10000)    #Enob: forcing MEM phi enob
...
#Constraint for cast for   %add36 = fadd double %tmp1, %tmp, !taffo.info !49, !taffo.initweight !30
...
mathCostObj +=  + (1.43251)*main_add36_fixp
mathCostObj +=  + (1.47242)*main_add36_float
mathCostObj +=  + (2.6385)*main_add36_double
...
#Constraint for cast for   store double %add36, double* %arrayidx35, align 8, !taffo.info !13, !taffo.initweight !29
...
#Stuff for double 2.800000e+01
ConstantValue__8_fixbits = solver.IntVar(0, 27, 'ConstantValue__8_fixbits')
...
solver.Add( + (1)*ConstantValue__8_enob + (10000)*ConstantValue__8_float<=10019)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__8_enob + (10000)*ConstantValue__8_double<=10048)    #Enob constraint for double
solver.Add( + (1)*ConstantValue__8_fixbits + (-10000)*ConstantValue__8_fixp>=-9974)    #Limit the lower number of frac bits27
...
#Constraint for cast for   %div42 = fdiv double %tmp2, 2.800000e+01, !taffo.info !51, !taffo.initweight !29, !taffo.constinfo !44
...
solver.Add( + (1)*ConstantValue__9_enob + (10000)*ConstantValue__9_float<=10019)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__9_enob + (10000)*ConstantValue__9_double<=10048)    #Enob constraint for double
solver.Add( + (1)*ConstantValue__9_fixbits + (-10000)*ConstantValue__9_fixp>=-9974)    #Limit the lower number of frac bits27
...
#Constraint for cast for   %div42 = fdiv double %tmp2, 2.800000e+01, !taffo.info !51, !taffo.initweight !29, !taffo.constinfo !44
ConstantValue__9_CAST_div42_fixbits = solver.IntVar(0, 27, 'ConstantValue__9_CAST_div42_fixbits')
ConstantValue__9_CAST_div42_fixp = solver.IntVar(0, 1, 'ConstantValue__9_CAST_div42_fixp')
ConstantValue__9_CAST_div42_float = solver.IntVar(0, 1, 'ConstantValue__9_CAST_div42_float')
ConstantValue__9_CAST_div42_double = solver.IntVar(0, 1, 'ConstantValue__9_CAST_div42_double')
solver.Add( + (1)*ConstantValue__9_CAST_div42_fixp + (1)*ConstantValue__9_CAST_div42_float + (1)*ConstantValue__9_CAST_div42_double==1)    #exactly 1 type
solver.Add( + (1)*ConstantValue__9_CAST_div42_fixbits + (-10000)*ConstantValue__9_CAST_div42_fixp<=0)    #If no fix, fix frac part = 0
C1_ConstantValue__9_CAST_div42 = solver.IntVar(0, 1, 'C1_ConstantValue__9_CAST_div42')
C2_ConstantValue__9_CAST_div42 = solver.IntVar(0, 1, 'C2_ConstantValue__9_CAST_div42')
solver.Add( + (1)*ConstantValue__9_fixbits + (-1)*ConstantValue__9_CAST_div42_fixbits + (-10000)*C1_ConstantValue__9_CAST_div42<=0)    #Shift cost 1
solver.Add( + (-1)*ConstantValue__9_fixbits + (1)*ConstantValue__9_CAST_div42_fixbits + (-10000)*C2_ConstantValue__9_CAST_div42<=0)    #Shift cost 2
castCostObj +=  + (1)*C1_ConstantValue__9_CAST_div42
castCostObj +=  + (1)*C2_ConstantValue__9_CAST_div42
C3_ConstantValue__9_CAST_div42 = solver.IntVar(0, 1, 'C3_ConstantValue__9_CAST_div42')
C4_ConstantValue__9_CAST_div42 = solver.IntVar(0, 1, 'C4_ConstantValue__9_CAST_div42')
C5_ConstantValue__9_CAST_div42 = solver.IntVar(0, 1, 'C5_ConstantValue__9_CAST_div42')
C6_ConstantValue__9_CAST_div42 = solver.IntVar(0, 1, 'C6_ConstantValue__9_CAST_div42')
C7_ConstantValue__9_CAST_div42 = solver.IntVar(0, 1, 'C7_ConstantValue__9_CAST_div42')
C8_ConstantValue__9_CAST_div42 = solver.IntVar(0, 1, 'C8_ConstantValue__9_CAST_div42')
solver.Add( + (1)*ConstantValue__9_fixp + (1)*ConstantValue__9_CAST_div42_float + (-1)*C3_ConstantValue__9_CAST_div42<=1)    #Fix to float
castCostObj +=  + (6.64554)*C3_ConstantValue__9_CAST_div42
solver.Add( + (1)*ConstantValue__9_float + (1)*ConstantValue__9_CAST_div42_fixp + (-1)*C4_ConstantValue__9_CAST_div42<=1)    #Float to fix
castCostObj +=  + (4.527)*C4_ConstantValue__9_CAST_div42
solver.Add( + (1)*ConstantValue__9_fixp + (1)*ConstantValue__9_CAST_div42_double + (-1)*C5_ConstantValue__9_CAST_div42<=1)    #Fix to double
castCostObj +=  + (7.54108)*C5_ConstantValue__9_CAST_div42
solver.Add( + (1)*ConstantValue__9_double + (1)*ConstantValue__9_CAST_div42_fixp + (-1)*C6_ConstantValue__9_CAST_div42<=1)    #Double to fix
castCostObj +=  + (3.31338)*C6_ConstantValue__9_CAST_div42
solver.Add( + (1)*ConstantValue__9_float + (1)*ConstantValue__9_CAST_div42_double + (-1)*C7_ConstantValue__9_CAST_div42<=1)    #Float to double
castCostObj +=  + (1.69718)*C7_ConstantValue__9_CAST_div42
solver.Add( + (1)*ConstantValue__9_double + (1)*ConstantValue__9_CAST_div42_float + (-1)*C8_ConstantValue__9_CAST_div42<=1)    #Double to float
castCostObj +=  + (1.39671)*C8_ConstantValue__9_CAST_div42



#Stuff for   %div42 = fdiv double %tmp2, 2.800000e+01, !taffo.info !51, !taffo.initweight !29, !taffo.constinfo !44
...
solver.Add( + (1)*main_div42_enob + (10000)*main_div42_float<=10149)    #Enob constraint for float
solver.Add( + (1)*main_div42_enob + (10000)*main_div42_double<=11074)    #Enob constraint for double
...
solver.Add( + (1)*main_mean_CAST_div42_fixp + (-1)*ConstantValue__9_CAST_div42_fixp==0)    #fix equality
solver.Add( + (1)*main_mean_CAST_div42_float + (-1)*ConstantValue__9_CAST_div42_float==0)    #float equality
solver.Add( + (1)*main_mean_CAST_div42_double + (-1)*ConstantValue__9_CAST_div42_double==0)    #double equality
...
mathCostObj +=  + (13.2477)*main_div42_fixp
mathCostObj +=  + (6.64202)*main_div42_float
mathCostObj +=  + (7.0892)*main_div42_double
...
solver.Add( + (1)*main_div42_enob + (-1)*ConstantValue__7_enob + (-10000)*main_main_div42_enob_1<=1034)    #Enob: propagation in division 1
solver.Add( + (1)*main_div42_enob + (-1)*main_mean_enob_memphi_main_tmp2 + (-10000)*main_main_div42_enob_2<=5)    #Enob: propagation in division 2



#Constraint for cast for   store double %div42, double* %arrayidx41, align 8, !taffo.info !13, !taffo.initweight !29
...
#Constraint for cast for   store double 0.000000e+00, double* %arrayidx51, align 8, !taffo.info !21, !taffo.initweight !29, !taffo.constinfo !48
...
castCostObj +=  + (6.64554)*C3_ConstantValue__11_CAST_store
...
castCostObj +=  + (4.527)*C4_ConstantValue__11_CAST_store
...
castCostObj +=  + (7.54108)*C5_ConstantValue__11_CAST_store
...
castCostObj +=  + (3.31338)*C6_ConstantValue__11_CAST_store
...
castCostObj +=  + (1.69718)*C7_ConstantValue__11_CAST_store
...
castCostObj +=  + (1.39671)*C8_ConstantValue__11_CAST_store
solver.Add( + (1)*main_stddev_fixp + (-1)*ConstantValue__11_CAST_store_fixp==0)    #fix equality
solver.Add( + (1)*main_stddev_float + (-1)*ConstantValue__11_CAST_store_float==0)    #float equality
solver.Add( + (1)*main_stddev_double + (-1)*ConstantValue__11_CAST_store_double==0)    #double equality
solver.Add( + (1)*main_stddev_fixbits + (-1)*ConstantValue__11_CAST_store_fixbits==0)    #same fractional bit
...
#Closing MEM phi loop...
solver.Add( + (1)*main_data_enob_memphi_main_tmp3 + (-1)*main_data_enob_storeENOB + (10000)*main_main_tmp3_enob_1<=10000)    #Enob: forcing MEM phi enob
...
#Closing MEM phi loop...
solver.Add( + (1)*main_mean_enob_memphi_main_tmp4 + (-1)*main_data_enob_storeENOB + (10000)*main_main_tmp4_enob_1<=10000)    #Enob: forcing MEM phi enob
...
#Constraint for cast for   %sub = fsub double %tmp3, %tmp4, !taffo.info !49, !taffo.initweight !30
...
mathCostObj +=  + (1.43251)*main_sub_fixp
mathCostObj +=  + (1.47242)*main_sub_float
mathCostObj +=  + (2.6385)*main_sub_double
...
#Closing MEM phi loop...
solver.Add( + (1)*main_data_enob_memphi_main_tmp5 + (-1)*main_data_enob_storeENOB + (10000)*main_main_tmp5_enob_1<=10000)    #Enob: forcing MEM phi enob
...
#Closing MEM phi loop...
solver.Add( + (1)*main_mean_enob_memphi_main_tmp6 + (-1)*main_data_enob_storeENOB + (10000)*main_main_tmp6_enob_1<=10000)    #Enob: forcing MEM phi enob
...
#Constraint for cast for   %sub68 = fsub double %tmp5, %tmp6, !taffo.info !49, !taffo.initweight !30
...
mathCostObj +=  + (1.43251)*main_sub68_fixp
mathCostObj +=  + (1.47242)*main_sub68_float
mathCostObj +=  + (2.6385)*main_sub68_double
...
#Constraint for cast for   %mul69 = fmul double %sub, %sub68, !taffo.info !53, !taffo.initweight !36
...
solver.Add( + (1)*main_mul69_fixbits + (-10000)*main_mul69_fixp>=-9970)    #Limit the lower number of frac bits31
...
mathCostObj +=  + (2.64906)*main_mul69_fixp
mathCostObj +=  + (4.52523)*main_mul69_float
mathCostObj +=  + (3.01526)*main_mul69_double
...
#Constraint for cast for   %add72 = fadd double %tmp7, %mul69, !taffo.info !55, !taffo.initweight !30
...
solver.Add( + (1)*main_add72_fixbits + (-10000)*main_add72_fixp>=-9970)    #Limit the lower number of frac bits31
solver.Add( + (1)*main_add72_enob<=4)    #Enob constraint for error maximal
...
mathCostObj +=  + (1.43251)*main_add72_fixp
mathCostObj +=  + (1.47242)*main_add72_float
mathCostObj +=  + (2.6385)*main_add72_double
...
#Constraint for cast for   store double %add72, double* %arrayidx71, align 8, !taffo.info !21, !taffo.initweight !29
main_add72_CAST_store_fixbits = solver.IntVar(0, 31, 'main_add72_CAST_store_fixbits')
...
#Stuff for double 2.800000e+01
ConstantValue__13_fixbits = solver.IntVar(0, 27, 'ConstantValue__13_fixbits')
...
solver.Add( + (1)*ConstantValue__13_enob + (10000)*ConstantValue__13_float<=10019)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__13_enob + (10000)*ConstantValue__13_double<=10048)    #Enob constraint for double
solver.Add( + (1)*ConstantValue__13_fixbits + (-10000)*ConstantValue__13_fixp>=-9974)    #Limit the lower number of frac bits27
...
#Constraint for cast for   %div78 = fdiv double %tmp8, 2.800000e+01, !taffo.info !57, !taffo.initweight !29, !taffo.constinfo !44
...
solver.Add( + (1)*ConstantValue__14_enob + (10000)*ConstantValue__14_float<=10019)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__14_enob + (10000)*ConstantValue__14_double<=10048)    #Enob constraint for double
solver.Add( + (1)*ConstantValue__14_fixbits + (-10000)*ConstantValue__14_fixp>=-9974)    #Limit the lower number of frac bits27
...
#Constraint for cast for   %div78 = fdiv double %tmp8, 2.800000e+01, !taffo.info !57, !taffo.initweight !29, !taffo.constinfo !44
ConstantValue__14_CAST_div78_fixbits = solver.IntVar(0, 27, 'ConstantValue__14_CAST_div78_fixbits')
ConstantValue__14_CAST_div78_fixp = solver.IntVar(0, 1, 'ConstantValue__14_CAST_div78_fixp')
ConstantValue__14_CAST_div78_float = solver.IntVar(0, 1, 'ConstantValue__14_CAST_div78_float')
ConstantValue__14_CAST_div78_double = solver.IntVar(0, 1, 'ConstantValue__14_CAST_div78_double')
solver.Add( + (1)*ConstantValue__14_CAST_div78_fixp + (1)*ConstantValue__14_CAST_div78_float + (1)*ConstantValue__14_CAST_div78_double==1)    #exactly 1 type
solver.Add( + (1)*ConstantValue__14_CAST_div78_fixbits + (-10000)*ConstantValue__14_CAST_div78_fixp<=0)    #If no fix, fix frac part = 0
C1_ConstantValue__14_CAST_div78 = solver.IntVar(0, 1, 'C1_ConstantValue__14_CAST_div78')
C2_ConstantValue__14_CAST_div78 = solver.IntVar(0, 1, 'C2_ConstantValue__14_CAST_div78')
solver.Add( + (1)*ConstantValue__14_fixbits + (-1)*ConstantValue__14_CAST_div78_fixbits + (-10000)*C1_ConstantValue__14_CAST_div78<=0)    #Shift cost 1
solver.Add( + (-1)*ConstantValue__14_fixbits + (1)*ConstantValue__14_CAST_div78_fixbits + (-10000)*C2_ConstantValue__14_CAST_div78<=0)    #Shift cost 2
castCostObj +=  + (1)*C1_ConstantValue__14_CAST_div78
castCostObj +=  + (1)*C2_ConstantValue__14_CAST_div78
C3_ConstantValue__14_CAST_div78 = solver.IntVar(0, 1, 'C3_ConstantValue__14_CAST_div78')
C4_ConstantValue__14_CAST_div78 = solver.IntVar(0, 1, 'C4_ConstantValue__14_CAST_div78')
C5_ConstantValue__14_CAST_div78 = solver.IntVar(0, 1, 'C5_ConstantValue__14_CAST_div78')
C6_ConstantValue__14_CAST_div78 = solver.IntVar(0, 1, 'C6_ConstantValue__14_CAST_div78')
C7_ConstantValue__14_CAST_div78 = solver.IntVar(0, 1, 'C7_ConstantValue__14_CAST_div78')
C8_ConstantValue__14_CAST_div78 = solver.IntVar(0, 1, 'C8_ConstantValue__14_CAST_div78')
solver.Add( + (1)*ConstantValue__14_fixp + (1)*ConstantValue__14_CAST_div78_float + (-1)*C3_ConstantValue__14_CAST_div78<=1)    #Fix to float
castCostObj +=  + (6.64554)*C3_ConstantValue__14_CAST_div78
solver.Add( + (1)*ConstantValue__14_float + (1)*ConstantValue__14_CAST_div78_fixp + (-1)*C4_ConstantValue__14_CAST_div78<=1)    #Float to fix
castCostObj +=  + (4.527)*C4_ConstantValue__14_CAST_div78
solver.Add( + (1)*ConstantValue__14_fixp + (1)*ConstantValue__14_CAST_div78_double + (-1)*C5_ConstantValue__14_CAST_div78<=1)    #Fix to double
castCostObj +=  + (7.54108)*C5_ConstantValue__14_CAST_div78
solver.Add( + (1)*ConstantValue__14_double + (1)*ConstantValue__14_CAST_div78_fixp + (-1)*C6_ConstantValue__14_CAST_div78<=1)    #Double to fix
castCostObj +=  + (3.31338)*C6_ConstantValue__14_CAST_div78
solver.Add( + (1)*ConstantValue__14_float + (1)*ConstantValue__14_CAST_div78_double + (-1)*C7_ConstantValue__14_CAST_div78<=1)    #Float to double
castCostObj +=  + (1.69718)*C7_ConstantValue__14_CAST_div78
solver.Add( + (1)*ConstantValue__14_double + (1)*ConstantValue__14_CAST_div78_float + (-1)*C8_ConstantValue__14_CAST_div78<=1)    #Double to float
castCostObj +=  + (1.39671)*C8_ConstantValue__14_CAST_div78



#Stuff for   %div78 = fdiv double %tmp8, 2.800000e+01, !taffo.info !57, !taffo.initweight !29, !taffo.constinfo !44
main_div78_fixbits = solver.IntVar(0, 23, 'main_div78_fixbits')
...
solver.Add( + (1)*main_div78_enob + (10000)*main_div78_float<=10149)    #Enob constraint for float
solver.Add( + (1)*main_div78_enob + (10000)*main_div78_double<=11074)    #Enob constraint for double
solver.Add( + (1)*main_div78_fixbits + (-10000)*main_div78_fixp>=-9978)    #Limit the lower number of frac bits23
...
solver.Add( + (1)*main_stddev_CAST_div78_fixp + (-1)*ConstantValue__14_CAST_div78_fixp==0)    #fix equality
solver.Add( + (1)*main_stddev_CAST_div78_float + (-1)*ConstantValue__14_CAST_div78_float==0)    #float equality
solver.Add( + (1)*main_stddev_CAST_div78_double + (-1)*ConstantValue__14_CAST_div78_double==0)    #double equality
...
mathCostObj +=  + (13.2477)*main_div78_fixp
mathCostObj +=  + (6.64202)*main_div78_float
mathCostObj +=  + (7.0892)*main_div78_double
...
solver.Add( + (1)*main_div78_enob + (-1)*ConstantValue__12_enob + (-10000)*main_main_div78_enob_1<=1034)    #Enob: propagation in division 1
solver.Add( + (1)*main_div78_enob + (-1)*main_stddev_enob_memphi_main_tmp8 + (-10000)*main_main_div78_enob_2<=5)    #Enob: propagation in division 2



#Constraint for cast for   store double %div78, double* %arrayidx77, align 8, !taffo.info !21, !taffo.initweight !29
main_div78_CAST_store_fixbits = solver.IntVar(0, 23, 'main_div78_CAST_store_fixbits')
...
#Stuff for   %call = call double @sqrt(double %tmp9) #2, !taffo.info !59, !taffo.initweight !30, !taffo.constinfo !47
...
#Constraint for cast for   %call = call double @sqrt(double %tmp9) #2, !taffo.info !59, !taffo.initweight !30, !taffo.constinfo !47
...
#Constraint for cast for   %cmp85 = fcmp ole double %tmp10, 1.000000e-01, !taffo.info !61, !taffo.initweight !29
...
solver.Add( + (1)*ConstantValue__16_enob + (10000)*ConstantValue__16_float<=10027)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__16_enob + (10000)*ConstantValue__16_double<=10056)    #Enob constraint for double
...
#Constraint for cast for   %cmp85 = fcmp ole double %tmp10, 1.000000e-01, !taffo.info !61, !taffo.initweight !29
ConstantValue__16_CAST_cmp85_fixbits = solver.IntVar(0, 31, 'ConstantValue__16_CAST_cmp85_fixbits')
ConstantValue__16_CAST_cmp85_fixp = solver.IntVar(0, 1, 'ConstantValue__16_CAST_cmp85_fixp')
ConstantValue__16_CAST_cmp85_float = solver.IntVar(0, 1, 'ConstantValue__16_CAST_cmp85_float')
ConstantValue__16_CAST_cmp85_double = solver.IntVar(0, 1, 'ConstantValue__16_CAST_cmp85_double')
solver.Add( + (1)*ConstantValue__16_CAST_cmp85_fixp + (1)*ConstantValue__16_CAST_cmp85_float + (1)*ConstantValue__16_CAST_cmp85_double==1)    #exactly 1 type
solver.Add( + (1)*ConstantValue__16_CAST_cmp85_fixbits + (-10000)*ConstantValue__16_CAST_cmp85_fixp<=0)    #If no fix, fix frac part = 0
C1_ConstantValue__16_CAST_cmp85 = solver.IntVar(0, 1, 'C1_ConstantValue__16_CAST_cmp85')
C2_ConstantValue__16_CAST_cmp85 = solver.IntVar(0, 1, 'C2_ConstantValue__16_CAST_cmp85')
solver.Add( + (1)*ConstantValue__16_fixbits + (-1)*ConstantValue__16_CAST_cmp85_fixbits + (-10000)*C1_ConstantValue__16_CAST_cmp85<=0)    #Shift cost 1
solver.Add( + (-1)*ConstantValue__16_fixbits + (1)*ConstantValue__16_CAST_cmp85_fixbits + (-10000)*C2_ConstantValue__16_CAST_cmp85<=0)    #Shift cost 2
castCostObj +=  + (1)*C1_ConstantValue__16_CAST_cmp85
castCostObj +=  + (1)*C2_ConstantValue__16_CAST_cmp85
C3_ConstantValue__16_CAST_cmp85 = solver.IntVar(0, 1, 'C3_ConstantValue__16_CAST_cmp85')
C4_ConstantValue__16_CAST_cmp85 = solver.IntVar(0, 1, 'C4_ConstantValue__16_CAST_cmp85')
C5_ConstantValue__16_CAST_cmp85 = solver.IntVar(0, 1, 'C5_ConstantValue__16_CAST_cmp85')
C6_ConstantValue__16_CAST_cmp85 = solver.IntVar(0, 1, 'C6_ConstantValue__16_CAST_cmp85')
C7_ConstantValue__16_CAST_cmp85 = solver.IntVar(0, 1, 'C7_ConstantValue__16_CAST_cmp85')
C8_ConstantValue__16_CAST_cmp85 = solver.IntVar(0, 1, 'C8_ConstantValue__16_CAST_cmp85')
solver.Add( + (1)*ConstantValue__16_fixp + (1)*ConstantValue__16_CAST_cmp85_float + (-1)*C3_ConstantValue__16_CAST_cmp85<=1)    #Fix to float
castCostObj +=  + (6.64554)*C3_ConstantValue__16_CAST_cmp85
solver.Add( + (1)*ConstantValue__16_float + (1)*ConstantValue__16_CAST_cmp85_fixp + (-1)*C4_ConstantValue__16_CAST_cmp85<=1)    #Float to fix
castCostObj +=  + (4.527)*C4_ConstantValue__16_CAST_cmp85
solver.Add( + (1)*ConstantValue__16_fixp + (1)*ConstantValue__16_CAST_cmp85_double + (-1)*C5_ConstantValue__16_CAST_cmp85<=1)    #Fix to double
castCostObj +=  + (7.54108)*C5_ConstantValue__16_CAST_cmp85
solver.Add( + (1)*ConstantValue__16_double + (1)*ConstantValue__16_CAST_cmp85_fixp + (-1)*C6_ConstantValue__16_CAST_cmp85<=1)    #Double to fix
castCostObj +=  + (3.31338)*C6_ConstantValue__16_CAST_cmp85
solver.Add( + (1)*ConstantValue__16_float + (1)*ConstantValue__16_CAST_cmp85_double + (-1)*C7_ConstantValue__16_CAST_cmp85<=1)    #Float to double
castCostObj +=  + (1.69718)*C7_ConstantValue__16_CAST_cmp85
solver.Add( + (1)*ConstantValue__16_double + (1)*ConstantValue__16_CAST_cmp85_float + (-1)*C8_ConstantValue__16_CAST_cmp85<=1)    #Double to float
castCostObj +=  + (1.39671)*C8_ConstantValue__16_CAST_cmp85
solver.Add( + (1)*main_stddev_CAST_cmp85_fixp + (-1)*ConstantValue__16_CAST_cmp85_fixp==0)    #fix equality
solver.Add( + (1)*main_stddev_CAST_cmp85_float + (-1)*ConstantValue__16_CAST_cmp85_float==0)    #float equality
solver.Add( + (1)*main_stddev_CAST_cmp85_double + (-1)*ConstantValue__16_CAST_cmp85_double==0)    #double equality
solver.Add( + (1)*main_stddev_CAST_cmp85_fixbits + (-1)*ConstantValue__16_CAST_cmp85_fixbits==0)    #same fractional bit
...
#Stuff for   %cond = phi double [ 1.000000e+00, %cond.true ], [ %tmp11, %cond.false ], !taffo.info !21, !taffo.initweight !30
...
solver.Add( + (1)*ConstantValue__18_enob + (10000)*ConstantValue__18_float<=10023)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__18_enob + (10000)*ConstantValue__18_double<=10052)    #Enob constraint for double
...
#Constraint for cast for   %cond = phi double [ 1.000000e+00, %cond.true ], [ %tmp11, %cond.false ], !taffo.info !21, !taffo.initweight !30
...
#Constraint for cast for   store double %cond, double* %arrayidx90, align 8, !taffo.info !21, !taffo.initweight !29
...
#Closing MEM phi loop...
solver.Add( + (1)*main_mean_enob_memphi_main_tmp12 + (-1)*main_data_enob_storeENOB + (10000)*main_main_tmp12_enob_1<=10000)    #Enob: forcing MEM phi enob
...
#Closing MEM phi loop...
solver.Add( + (1)*main_data_enob_memphi_main_tmp13 + (-1)*main_data_enob_storeENOB + (10000)*main_main_tmp13_enob_1<=10000)    #Enob: forcing MEM phi enob
...
#Constraint for cast for   %sub108 = fsub double %tmp13, %tmp12, !taffo.info !49, !taffo.initweight !30
...
mathCostObj +=  + (1.43251)*main_sub108_fixp
mathCostObj +=  + (1.47242)*main_sub108_float
mathCostObj +=  + (2.6385)*main_sub108_double
...
#Constraint for cast for   store double %sub108, double* %arrayidx107, align 8, !taffo.info !17, !taffo.initweight !30
...
solver.Add( + (1)*main_data_enob_storeENOB_storeENOB + (-1)*main_sub108_enob<=0)    #Enob constraint ENOB propagation in load/store



#Stuff for   %call109 = call double @sqrt(double 2.800000e+01) #2, !taffo.info !64, !taffo.initweight !29, !taffo.constinfo !66
main_call109_fixbits = solver.IntVar(0, 29, 'main_call109_fixbits')
...
solver.Add( + (1)*main_call109_enob + (10000)*main_call109_float<=10021)    #Enob constraint for float
solver.Add( + (1)*main_call109_enob + (10000)*main_call109_double<=10050)    #Enob constraint for double
solver.Add( + (1)*main_call109_fixbits + (-10000)*main_call109_fixp>=-9972)    #Limit the lower number of frac bits29
...
#Stuff for double 2.800000e+01
ConstantValue__19_fixbits = solver.IntVar(0, 27, 'ConstantValue__19_fixbits')
...
solver.Add( + (1)*ConstantValue__19_enob + (10000)*ConstantValue__19_float<=10019)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__19_enob + (10000)*ConstantValue__19_double<=10048)    #Enob constraint for double
solver.Add( + (1)*ConstantValue__19_fixbits + (-10000)*ConstantValue__19_fixp>=-9974)    #Limit the lower number of frac bits27
...
#Stuff for double 2.800000e+01
ConstantValue__20_fixbits = solver.IntVar(0, 27, 'ConstantValue__20_fixbits')
...
solver.Add( + (1)*ConstantValue__20_enob + (10000)*ConstantValue__20_float<=10019)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__20_enob + (10000)*ConstantValue__20_double<=10048)    #Enob constraint for double
solver.Add( + (1)*ConstantValue__20_fixbits + (-10000)*ConstantValue__20_fixp>=-9974)    #Limit the lower number of frac bits27
...
#Constraint for cast for   %call109 = call double @sqrt(double 2.800000e+01) #2, !taffo.info !64, !taffo.initweight !29, !taffo.constinfo !66
ConstantValue__20_CAST_call109_fixbits = solver.IntVar(0, 27, 'ConstantValue__20_CAST_call109_fixbits')
ConstantValue__20_CAST_call109_fixp = solver.IntVar(0, 1, 'ConstantValue__20_CAST_call109_fixp')
ConstantValue__20_CAST_call109_float = solver.IntVar(0, 1, 'ConstantValue__20_CAST_call109_float')
ConstantValue__20_CAST_call109_double = solver.IntVar(0, 1, 'ConstantValue__20_CAST_call109_double')
solver.Add( + (1)*ConstantValue__20_CAST_call109_fixp + (1)*ConstantValue__20_CAST_call109_float + (1)*ConstantValue__20_CAST_call109_double==1)    #exactly 1 type
solver.Add( + (1)*ConstantValue__20_CAST_call109_fixbits + (-10000)*ConstantValue__20_CAST_call109_fixp<=0)    #If no fix, fix frac part = 0
C1_ConstantValue__20_CAST_call109 = solver.IntVar(0, 1, 'C1_ConstantValue__20_CAST_call109')
C2_ConstantValue__20_CAST_call109 = solver.IntVar(0, 1, 'C2_ConstantValue__20_CAST_call109')
solver.Add( + (1)*ConstantValue__20_fixbits + (-1)*ConstantValue__20_CAST_call109_fixbits + (-10000)*C1_ConstantValue__20_CAST_call109<=0)    #Shift cost 1
solver.Add( + (-1)*ConstantValue__20_fixbits + (1)*ConstantValue__20_CAST_call109_fixbits + (-10000)*C2_ConstantValue__20_CAST_call109<=0)    #Shift cost 2
castCostObj +=  + (1)*C1_ConstantValue__20_CAST_call109
castCostObj +=  + (1)*C2_ConstantValue__20_CAST_call109
C3_ConstantValue__20_CAST_call109 = solver.IntVar(0, 1, 'C3_ConstantValue__20_CAST_call109')
C4_ConstantValue__20_CAST_call109 = solver.IntVar(0, 1, 'C4_ConstantValue__20_CAST_call109')
C5_ConstantValue__20_CAST_call109 = solver.IntVar(0, 1, 'C5_ConstantValue__20_CAST_call109')
C6_ConstantValue__20_CAST_call109 = solver.IntVar(0, 1, 'C6_ConstantValue__20_CAST_call109')
C7_ConstantValue__20_CAST_call109 = solver.IntVar(0, 1, 'C7_ConstantValue__20_CAST_call109')
C8_ConstantValue__20_CAST_call109 = solver.IntVar(0, 1, 'C8_ConstantValue__20_CAST_call109')
solver.Add( + (1)*ConstantValue__20_fixp + (1)*ConstantValue__20_CAST_call109_float + (-1)*C3_ConstantValue__20_CAST_call109<=1)    #Fix to float
castCostObj +=  + (6.64554)*C3_ConstantValue__20_CAST_call109
solver.Add( + (1)*ConstantValue__20_float + (1)*ConstantValue__20_CAST_call109_fixp + (-1)*C4_ConstantValue__20_CAST_call109<=1)    #Float to fix
castCostObj +=  + (4.527)*C4_ConstantValue__20_CAST_call109
solver.Add( + (1)*ConstantValue__20_fixp + (1)*ConstantValue__20_CAST_call109_double + (-1)*C5_ConstantValue__20_CAST_call109<=1)    #Fix to double
castCostObj +=  + (7.54108)*C5_ConstantValue__20_CAST_call109
solver.Add( + (1)*ConstantValue__20_double + (1)*ConstantValue__20_CAST_call109_fixp + (-1)*C6_ConstantValue__20_CAST_call109<=1)    #Double to fix
castCostObj +=  + (3.31338)*C6_ConstantValue__20_CAST_call109
solver.Add( + (1)*ConstantValue__20_float + (1)*ConstantValue__20_CAST_call109_double + (-1)*C7_ConstantValue__20_CAST_call109<=1)    #Float to double
castCostObj +=  + (1.69718)*C7_ConstantValue__20_CAST_call109
solver.Add( + (1)*ConstantValue__20_double + (1)*ConstantValue__20_CAST_call109_float + (-1)*C8_ConstantValue__20_CAST_call109<=1)    #Double to float
castCostObj +=  + (1.39671)*C8_ConstantValue__20_CAST_call109
solver.Add( + (1)*ConstantValue__20_CAST_call109_double==1)    #Type constraint for argument value
...
#Closing MEM phi loop...
solver.Add( + (1)*main_stddev_enob_memphi_main_tmp14 + (-1)*main_data_enob_storeENOB + (10000)*main_main_tmp14_enob_1<=10000)    #Enob: forcing MEM phi enob
...
#Constraint for cast for   %mul112 = fmul double %call109, %tmp14, !taffo.info !67, !taffo.initweight !30
main_call109_CAST_mul112_fixbits = solver.IntVar(0, 29, 'main_call109_CAST_mul112_fixbits')
...
solver.Add( + (1)*main_mul112_fixbits + (-10000)*main_mul112_fixp>=-9985)    #Limit the lower number of frac bits16
solver.Add( + (1)*main_mul112_enob<=4)    #Enob constraint for error maximal
...
mathCostObj +=  + (2.64906)*main_mul112_fixp
mathCostObj +=  + (4.52523)*main_mul112_float
mathCostObj +=  + (3.01526)*main_mul112_double
...
solver.Add( + (1)*main_mul112_enob + (-1)*main_stddev_enob_memphi_main_tmp14 + (-10000)*main_main_mul112_enob_1<=-2)    #Enob: propagation in product 1
...
#Closing MEM phi loop...
solver.Add( + (1)*main_data_enob_memphi_main_tmp15 + (-1)*main_data_enob_storeENOB_storeENOB + (10000)*main_main_tmp15_enob_0<=10000)    #Enob: forcing MEM phi enob



#Constraint for cast for   %div117 = fdiv double %tmp15, %mul112, !taffo.info !69, !taffo.initweight !36
...
solver.Add( + (1)*main_div117_fixbits + (-10000)*main_div117_fixp>=-9971)    #Limit the lower number of frac bits30
...
mathCostObj +=  + (13.2477)*main_div117_fixp
mathCostObj +=  + (6.64202)*main_div117_float
mathCostObj +=  + (7.0892)*main_div117_double
...
solver.Add( + (1)*main_div117_enob + (-1)*main_mul112_enob + (-10000)*main_main_div117_enob_1<=1052)    #Enob: propagation in division 1
solver.Add( + (1)*main_div117_enob + (-1)*main_data_enob_memphi_main_tmp15 + (-10000)*main_main_div117_enob_2<=1052)    #Enob: propagation in division 2



#Constraint for cast for   store double %div117, double* %arrayidx116, align 8, !taffo.info !17, !taffo.initweight !30
main_div117_CAST_store_fixbits = solver.IntVar(0, 30, 'main_div117_CAST_store_fixbits')
...
#Restriction for new enob [STORE]
main_data_enob_storeENOB_storeENOB_storeENOB = solver.IntVar(-10000, 10000, 'main_data_enob_storeENOB_storeENOB_storeENOB')
solver.Add( + (1)*main_data_enob_storeENOB_storeENOB_storeENOB + (-1)*main_data_fixbits + (10000)*main_data_fixp<=10000)    #Enob constraint for fix
solver.Add( + (1)*main_data_enob_storeENOB_storeENOB_storeENOB + (10000)*main_data_float<=10149)    #Enob constraint for float
solver.Add( + (1)*main_data_enob_storeENOB_storeENOB_storeENOB + (10000)*main_data_double<=11074)    #Enob constraint for double
solver.Add( + (1)*main_data_enob_storeENOB_storeENOB_storeENOB + (-1)*main_div117_enob<=0)    #Enob constraint ENOB propagation in load/store



#Closing MEM phi loop...
solver.Add( + (1)*main_data_enob_memphi_main_tmp13 + (-1)*main_data_enob_storeENOB_storeENOB_storeENOB + (10000)*main_main_tmp13_enob_4<=10000)    #Enob: forcing MEM phi enob
...
#Constraint for cast for   store double 1.000000e+00, double* %arrayidx131, align 8, !taffo.info !19, !taffo.initweight !30, !taffo.constinfo !71
ConstantValue__22_CAST_store_fixbits = solver.IntVar(0, 31, 'ConstantValue__22_CAST_store_fixbits')
...
castCostObj +=  + (6.64554)*C3_ConstantValue__22_CAST_store
...
castCostObj +=  + (4.527)*C4_ConstantValue__22_CAST_store
...
castCostObj +=  + (7.54108)*C5_ConstantValue__22_CAST_store
...
castCostObj +=  + (3.31338)*C6_ConstantValue__22_CAST_store
...
castCostObj +=  + (1.69718)*C7_ConstantValue__22_CAST_store
...
castCostObj +=  + (1.39671)*C8_ConstantValue__22_CAST_store
...
#Stuff for double 0.000000e+00
ConstantValue__24_fixbits = solver.IntVar(0, 32, 'ConstantValue__24_fixbits')
...
solver.Add( + (1)*ConstantValue__24_enob + (10000)*ConstantValue__24_float<=10149)    #Enob constraint for float
solver.Add( + (1)*ConstantValue__24_enob + (10000)*ConstantValue__24_double<=11074)    #Enob constraint for double
solver.Add( + (1)*ConstantValue__24_fixbits + (-10000)*ConstantValue__24_fixp>=-9969)    #Limit the lower number of frac bits32
...
#Constraint for cast for   store double 0.000000e+00, double* %arrayidx140, align 8, !taffo.info !19, !taffo.initweight !30, !taffo.constinfo !48
ConstantValue__24_CAST_store_fixbits = solver.IntVar(0, 32, 'ConstantValue__24_CAST_store_fixbits')
...
castCostObj +=  + (6.64554)*C3_ConstantValue__24_CAST_store
...
castCostObj +=  + (4.527)*C4_ConstantValue__24_CAST_store
...
castCostObj +=  + (7.54108)*C5_ConstantValue__24_CAST_store
...
castCostObj +=  + (3.31338)*C6_ConstantValue__24_CAST_store
...
castCostObj +=  + (1.69718)*C7_ConstantValue__24_CAST_store
...
castCostObj +=  + (1.39671)*C8_ConstantValue__24_CAST_store
...
#Closing MEM phi loop...
solver.Add( + (1)*main_data_enob_memphi_main_tmp16 + (-1)*main_data_enob_storeENOB + (10000)*main_main_tmp16_enob_1<=10000)    #Enob: forcing MEM phi enob
...
#Closing MEM phi loop...
solver.Add( + (1)*main_data_enob_memphi_main_tmp16 + (-1)*main_data_enob_storeENOB_storeENOB_storeENOB + (10000)*main_main_tmp16_enob_4<=10000)    #Enob: forcing MEM phi enob
...
#Closing MEM phi loop...
solver.Add( + (1)*main_data_enob_memphi_main_tmp17 + (-1)*main_data_enob_storeENOB + (10000)*main_main_tmp17_enob_1<=10000)    #Enob: forcing MEM phi enob
...
#Closing MEM phi loop...
solver.Add( + (1)*main_data_enob_memphi_main_tmp17 + (-1)*main_data_enob_storeENOB_storeENOB_storeENOB + (10000)*main_main_tmp17_enob_4<=10000)    #Enob: forcing MEM phi enob



#Constraint for cast for   %mul153 = fmul double %tmp16, %tmp17, !taffo.info !74, !taffo.initweight !36
...
solver.Add( + (1)*main_mul153_fixbits + (-10000)*main_mul153_fixp>=-9977)    #Limit the lower number of frac bits24
...
mathCostObj +=  + (2.64906)*main_mul153_fixp
mathCostObj +=  + (4.52523)*main_mul153_float
mathCostObj +=  + (3.01526)*main_mul153_double
...
#Constraint for cast for   %add158 = fadd double %tmp18, %mul153, !taffo.info !76, !taffo.initweight !36
...
solver.Add( + (1)*main_add158_fixbits + (-10000)*main_add158_fixp>=-9977)    #Limit the lower number of frac bits24
...
mathCostObj +=  + (1.43251)*main_add158_fixp
mathCostObj +=  + (1.47242)*main_add158_float
mathCostObj +=  + (2.6385)*main_add158_double
...
#Constraint for cast for   store double %add158, double* %arrayidx157, align 8, !taffo.info !19, !taffo.initweight !30
main_add158_CAST_store_fixbits = solver.IntVar(0, 24, 'main_add158_CAST_store_fixbits')
...
#Constraint for cast for   store double %tmp19, double* %arrayidx169, align 8, !taffo.info !19, !taffo.initweight !30
...
#Constraint for cast for   store double 1.000000e+00, double* %arrayidx177, align 8, !taffo.info !19, !taffo.initweight !30, !taffo.constinfo !71
ConstantValue__26_CAST_store_fixbits = solver.IntVar(0, 31, 'ConstantValue__26_CAST_store_fixbits')
ConstantValue__26_CAST_store_fixp = solver.IntVar(0, 1, 'ConstantValue__26_CAST_store_fixp')
ConstantValue__26_CAST_store_float = solver.IntVar(0, 1, 'ConstantValue__26_CAST_store_float')
ConstantValue__26_CAST_store_double = solver.IntVar(0, 1, 'ConstantValue__26_CAST_store_double')
solver.Add( + (1)*ConstantValue__26_CAST_store_fixp + (1)*ConstantValue__26_CAST_store_float + (1)*ConstantValue__26_CAST_store_double==1)    #exactly 1 type
solver.Add( + (1)*ConstantValue__26_CAST_store_fixbits + (-10000)*ConstantValue__26_CAST_store_fixp<=0)    #If no fix, fix frac part = 0
C1_ConstantValue__26_CAST_store = solver.IntVar(0, 1, 'C1_ConstantValue__26_CAST_store')
C2_ConstantValue__26_CAST_store = solver.IntVar(0, 1, 'C2_ConstantValue__26_CAST_store')
solver.Add( + (1)*ConstantValue__26_fixbits + (-1)*ConstantValue__26_CAST_store_fixbits + (-10000)*C1_ConstantValue__26_CAST_store<=0)    #Shift cost 1
solver.Add( + (-1)*ConstantValue__26_fixbits + (1)*ConstantValue__26_CAST_store_fixbits + (-10000)*C2_ConstantValue__26_CAST_store<=0)    #Shift cost 2
castCostObj +=  + (1)*C1_ConstantValue__26_CAST_store
castCostObj +=  + (1)*C2_ConstantValue__26_CAST_store
C3_ConstantValue__26_CAST_store = solver.IntVar(0, 1, 'C3_ConstantValue__26_CAST_store')
C4_ConstantValue__26_CAST_store = solver.IntVar(0, 1, 'C4_ConstantValue__26_CAST_store')
C5_ConstantValue__26_CAST_store = solver.IntVar(0, 1, 'C5_ConstantValue__26_CAST_store')
C6_ConstantValue__26_CAST_store = solver.IntVar(0, 1, 'C6_ConstantValue__26_CAST_store')
C7_ConstantValue__26_CAST_store = solver.IntVar(0, 1, 'C7_ConstantValue__26_CAST_store')
C8_ConstantValue__26_CAST_store = solver.IntVar(0, 1, 'C8_ConstantValue__26_CAST_store')
solver.Add( + (1)*ConstantValue__26_fixp + (1)*ConstantValue__26_CAST_store_float + (-1)*C3_ConstantValue__26_CAST_store<=1)    #Fix to float
castCostObj +=  + (6.64554)*C3_ConstantValue__26_CAST_store
solver.Add( + (1)*ConstantValue__26_float + (1)*ConstantValue__26_CAST_store_fixp + (-1)*C4_ConstantValue__26_CAST_store<=1)    #Float to fix
castCostObj +=  + (4.527)*C4_ConstantValue__26_CAST_store
solver.Add( + (1)*ConstantValue__26_fixp + (1)*ConstantValue__26_CAST_store_double + (-1)*C5_ConstantValue__26_CAST_store<=1)    #Fix to double
castCostObj +=  + (7.54108)*C5_ConstantValue__26_CAST_store
solver.Add( + (1)*ConstantValue__26_double + (1)*ConstantValue__26_CAST_store_fixp + (-1)*C6_ConstantValue__26_CAST_store<=1)    #Double to fix
castCostObj +=  + (3.31338)*C6_ConstantValue__26_CAST_store
solver.Add( + (1)*ConstantValue__26_float + (1)*ConstantValue__26_CAST_store_double + (-1)*C7_ConstantValue__26_CAST_store<=1)    #Float to double
castCostObj +=  + (1.69718)*C7_ConstantValue__26_CAST_store
solver.Add( + (1)*ConstantValue__26_double + (1)*ConstantValue__26_CAST_store_float + (-1)*C8_ConstantValue__26_CAST_store<=1)    #Double to float
castCostObj +=  + (1.39671)*C8_ConstantValue__26_CAST_store
solver.Add( + (1)*main_corr_fixp + (-1)*ConstantValue__26_CAST_store_fixp==0)    #fix equality
solver.Add( + (1)*main_corr_float + (-1)*ConstantValue__26_CAST_store_float==0)    #float equality
solver.Add( + (1)*main_corr_double + (-1)*ConstantValue__26_CAST_store_double==0)    #double equality
solver.Add( + (1)*main_corr_fixbits + (-1)*ConstantValue__26_CAST_store_fixbits==0)    #same fractional bit
...
#Constraint for cast for   %call190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.10, i32 0, i32 0), double %tmp20), !taffo.info !19, !taffo.initweight !36, !taffo.constinfo !78
...
solver.Minimize(1000 * castCostObj / 392.136+ 1 * enobCostObj / 9769+ 1000 * mathCostObj / 98.2834)
