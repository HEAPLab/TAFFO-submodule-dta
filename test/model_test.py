...
main_data_CAST_sub68_fixbits = solver.IntVar(0, 30, 'main_data_CAST_sub68_fixbits')
...
main_data_CAST_sub108_fixbits = solver.IntVar(0, 30, 'main_data_CAST_sub108_fixbits')
...
main_data_CAST_div117_fixbits = solver.IntVar(0, 30, 'main_data_CAST_div117_fixbits')
...
main_data_CAST_mul153_fixbits = solver.IntVar(0, 30, 'main_data_CAST_mul153_fixbits')
...
#Constraint for cast for   %mul153 = fmul double %tmp16, %tmp17, !taffo.info !15, !taffo.initweight !28
main_data_CAST_mul153_0_fixbits = solver.IntVar(0, 30, 'main_data_CAST_mul153_0_fixbits')
...
main_mul153_fixbits = solver.IntVar(0, 30, 'main_mul153_fixbits')
...
solver.Add( + (1)*main_mul153_fixbits + (-10000)*main_mul153_fixp>=-9971)    #Limit the lower number of frac bits30
...
#Constraint for cast for   %add158 = fadd double %tmp18, %mul153, !taffo.info !17, !taffo.initweight !28
main_mul153_CAST_add158_fixbits = solver.IntVar(0, 30, 'main_mul153_CAST_add158_fixbits')
...
#Constraint for cast for   %call190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.9, i32 0, i32 0), double %tmp20), !taffo.info !17, !taffo.initweight !28, !taffo.constinfo !46
...
solver.Minimize(48149.5 * castCostObj + 3701 * enobCostObj + 96299 * mathCostObj )
