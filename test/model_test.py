...
solver.Minimize( + (-1)*a_enob + (-1)*b_enob + (-1)*e_enob + (-1)*c_enob + (-1)*d_enob + (-1)*f_enob + (-1)*g_enob + (1)*C1_a_add + (1)*C2_a_add + (7.12299)*C3_a_add + (4.75613)*C4_a_add + (7.24176)*C5_a_add + (4.24007)*C6_a_add + (1.35841)*C7_a_add + (1.22485)*C8_a_add + (1)*C1_b_add + (1)*C2_b_add + (7.12299)*C3_b_add + (4.75613)*C4_b_add + (7.24176)*C5_b_add + (4.24007)*C6_b_add + (1.35841)*C7_b_add + (1.22485)*C8_b_add + (-1)*main_add_enob + (1.46661)*main_add_fixp + (1.38842)*main_add_float + (2.83601)*main_add_double + (1)*C1_main_add_ + (1)*C2_main_add_ + (7.12299)*C3_main_add_ + (4.75613)*C4_main_add_ + (7.24176)*C5_main_add_ + (4.24007)*C6_main_add_ + (1.35841)*C7_main_add_ + (1.22485)*C8_main_add_ + (1)*C1_c_add1 + (1)*C2_c_add1 + (7.12299)*C3_c_add1 + (4.75613)*C4_c_add1 + (7.24176)*C5_c_add1 + (4.24007)*C6_c_add1 + (1.35841)*C7_c_add1 + (1.22485)*C8_c_add1 + (1)*C1_d_add1 + (1)*C2_d_add1 + (7.12299)*C3_d_add1 + (4.75613)*C4_d_add1 + (7.24176)*C5_d_add1 + (4.24007)*C6_d_add1 + (1.35841)*C7_d_add1 + (1.22485)*C8_d_add1 + (-1)*main_add1_enob + (1.46661)*main_add1_fixp + (1.38842)*main_add1_float + (2.83601)*main_add1_double + (1)*C1_main_add1_ + (1)*C2_main_add1_ + (7.12299)*C3_main_add1_ + (4.75613)*C4_main_add1_ + (7.24176)*C5_main_add1_ + (4.24007)*C6_main_add1_ + (1.35841)*C7_main_add1_ + (1.22485)*C8_main_add1_ + (1)*C1_f_mul + (1)*C2_f_mul + (7.12299)*C3_f_mul + (4.75613)*C4_f_mul + (7.24176)*C5_f_mul + (4.24007)*C6_f_mul + (1.35841)*C7_f_mul + (1.22485)*C8_f_mul + (1)*C1_e_mul + (1)*C2_e_mul + (7.12299)*C3_e_mul + (4.75613)*C4_e_mul + (7.24176)*C5_e_mul + (4.24007)*C6_e_mul + (1.35841)*C7_e_mul + (1.22485)*C8_e_mul + (-1)*main_mul_enob + (1.47168)*main_mul_fixp + (3.83855)*main_mul_float + (2.88419)*main_mul_double + (1)*C1_main_mul_ + (1)*C2_main_mul_ + (7.12299)*C3_main_mul_ + (4.75613)*C4_main_mul_ + (7.24176)*C5_main_mul_ + (4.24007)*C6_main_mul_ + (1.35841)*C7_main_mul_ + (1.22485)*C8_main_mul_)
