...
@data = common dso_local global [260 x [240 x double]] zeroinitializer, align 16, !taffo.initweight !8, !taffo.info !9
@.str.5 = private unnamed_addr constant [9 x i8] c"scalar()\00", section "llvm.metadata", !taffo.info !4
@mean = common dso_local global [240 x double] zeroinitializer, align 16, !taffo.initweight !8, !taffo.info !12
@stddev = common dso_local global [240 x double] zeroinitializer, align 16, !taffo.initweight !8, !taffo.info !14
@corr = common dso_local global [240 x [240 x double]] zeroinitializer, align 16, !taffo.initweight !8, !taffo.info !17
...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  %cmp = icmp slt i32 %i.0, 260, !taffo.initweight !32, !taffo.info !33
...
for.cond5:                                        ; preds = %for.inc, %for.body
  ...
  %cmp6 = icmp slt i32 %j.0, 240, !taffo.initweight !32, !taffo.info !37
...
for.body7:                                        ; preds = %for.cond5
  ...
  %div = fdiv double %conv, 2.400000e+02, !taffo.initweight !38, !taffo.info !39, !taffo.constinfo !41
  ...
  %div9 = fdiv double %add, 2.600000e+02, !taffo.initweight !38, !taffo.info !46, !taffo.constinfo !48
  %idxprom = sext i32 %i.0 to i64, !taffo.initweight !32, !taffo.info !33
  %arrayidx = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom, !taffo.initweight !51, !taffo.info !9
  %idxprom10 = sext i32 %j.0 to i64, !taffo.initweight !32, !taffo.info !37
  %arrayidx11 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx, i64 0, i64 %idxprom10, !taffo.initweight !32, !taffo.info !9
...
for.cond16:                                       ; preds = %for.inc39, %for.end14
  ...
  %cmp17 = icmp slt i32 %j.1, 240, !taffo.initweight !32, !taffo.info !37
...
for.body19:                                       ; preds = %for.cond16
  ...
  %arrayidx21 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom20, !taffo.initweight !51, !taffo.info !12
...
for.cond22:                                       ; preds = %for.inc33, %for.body19
  ...
  %cmp23 = icmp slt i32 %i.1, 260, !taffo.initweight !32, !taffo.info !33
...
for.body25:                                       ; preds = %for.cond22
  ...
  %arrayidx27 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom26, !taffo.initweight !51, !taffo.info !9
  %idxprom28 = sext i32 %j.1 to i64, !taffo.initweight !32, !taffo.info !37
  %arrayidx29 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx27, i64 0, i64 %idxprom28, !taffo.initweight !32, !taffo.info !9
  ...
  %arrayidx31 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom30, !taffo.initweight !51, !taffo.info !12
...
for.end35:                                        ; preds = %for.cond22
  ...
  %arrayidx37 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom36, !taffo.initweight !51, !taffo.info !12
  %2 = load double, double* %arrayidx37, align 8, !taffo.initweight !32, !taffo.info !12
  %div38 = fdiv double %2, 2.600000e+02, !taffo.initweight !32, !taffo.info !55, !taffo.constinfo !48
...
for.cond42:                                       ; preds = %for.inc87, %for.end41
  ...
  %cmp43 = icmp slt i32 %j.2, 240, !taffo.initweight !32, !taffo.info !37
...
for.body45:                                       ; preds = %for.cond42
  ...
  %arrayidx47 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom46, !taffo.initweight !51, !taffo.info !14
...
for.cond48:                                       ; preds = %for.inc69, %for.body45
  ...
  %cmp49 = icmp slt i32 %i.2, 260, !taffo.initweight !32, !taffo.info !33
...
for.body51:                                       ; preds = %for.cond48
  ...
  %arrayidx53 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom52, !taffo.initweight !51, !taffo.info !9
  %idxprom54 = sext i32 %j.2 to i64, !taffo.initweight !32, !taffo.info !37
  %arrayidx55 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx53, i64 0, i64 %idxprom54, !taffo.initweight !32, !taffo.info !9
  ...
  %arrayidx57 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom56, !taffo.initweight !51, !taffo.info !12
  ...
  %arrayidx59 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom58, !taffo.initweight !51, !taffo.info !9
  %idxprom60 = sext i32 %j.2 to i64, !taffo.initweight !32, !taffo.info !37
  %arrayidx61 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx59, i64 0, i64 %idxprom60, !taffo.initweight !32, !taffo.info !9
  ...
  %arrayidx63 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom62, !taffo.initweight !51, !taffo.info !12
  ...
  %arrayidx67 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom66, !taffo.initweight !51, !taffo.info !14
...
for.end71:                                        ; preds = %for.cond48
  ...
  %arrayidx73 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom72, !taffo.initweight !51, !taffo.info !14
  %8 = load double, double* %arrayidx73, align 8, !taffo.initweight !32, !taffo.info !14
  %div74 = fdiv double %8, 2.600000e+02, !taffo.initweight !32, !taffo.info !61, !taffo.constinfo !48
  ...
  %arrayidx76 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom75, !taffo.initweight !51, !taffo.info !14
  ...
  %arrayidx78 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom77, !taffo.initweight !51, !taffo.info !14
  ...
  %arrayidx80 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom79, !taffo.initweight !51, !taffo.info !14
  ...
  br i1 %cmp81, label %cond.true, label %cond.false, !taffo.initweight !34, !taffo.info !66
...
cond.false:                                       ; preds = %for.end71
  ...
  %arrayidx84 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom83, !taffo.initweight !51, !taffo.info !14
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %arrayidx86 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom85, !taffo.initweight !51, !taffo.info !14
...
for.cond90:                                       ; preds = %for.inc117, %for.end89
  ...
  %cmp91 = icmp slt i32 %i.3, 260, !taffo.initweight !32, !taffo.info !33
...
for.cond94:                                       ; preds = %for.inc114, %for.body93
  ...
  %cmp95 = icmp slt i32 %j.3, 240, !taffo.initweight !32, !taffo.info !37
...
for.body97:                                       ; preds = %for.cond94
  ...
  %arrayidx99 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom98, !taffo.initweight !51, !taffo.info !12
  ...
  %arrayidx101 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom100, !taffo.initweight !51, !taffo.info !9
  %idxprom102 = sext i32 %j.3 to i64, !taffo.initweight !32, !taffo.info !37
  %arrayidx103 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx101, i64 0, i64 %idxprom102, !taffo.initweight !32, !taffo.info !9
  ...
  %call105 = call double @sqrt(double 2.600000e+02) #3, !taffo.initweight !32, !taffo.info !67, !taffo.constinfo !69
  %idxprom106 = sext i32 %j.3 to i64, !taffo.initweight !32, !taffo.info !37
  %arrayidx107 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom106, !taffo.initweight !51, !taffo.info !14
  %14 = load double, double* %arrayidx107, align 8, !taffo.initweight !32, !taffo.info !14
  %mul108 = fmul double %call105, %14, !taffo.initweight !34, !taffo.info !70
  %idxprom109 = sext i32 %i.3 to i64, !taffo.initweight !32, !taffo.info !33
  %arrayidx110 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom109, !taffo.initweight !51, !taffo.info !9
  %idxprom111 = sext i32 %j.3 to i64, !taffo.initweight !32, !taffo.info !37
  %arrayidx112 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx110, i64 0, i64 %idxprom111, !taffo.initweight !32, !taffo.info !9
  %15 = load double, double* %arrayidx112, align 8, !taffo.initweight !34, !taffo.info !9
  %div113 = fdiv double %15, %mul108, !taffo.initweight !38, !taffo.info !72
...
for.cond120:                                      ; preds = %for.inc169, %for.end119
  ...
  %cmp121 = icmp slt i32 %i.4, 239, !taffo.initweight !32, !taffo.info !33
...
for.body123:                                      ; preds = %for.cond120
  ...
  %arrayidx125 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom124, !taffo.initweight !51, !taffo.info !17
  %idxprom126 = sext i32 %i.4 to i64, !taffo.initweight !32, !taffo.info !33
  %arrayidx127 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx125, i64 0, i64 %idxprom126, !taffo.initweight !32, !taffo.info !17
  store double 1.000000e+00, double* %arrayidx127, align 8, !taffo.initweight !34, !taffo.info !17, !taffo.constinfo !74
...
for.cond129:                                      ; preds = %for.inc166, %for.body123
  ...
  %cmp130 = icmp slt i32 %j.4, 240, !taffo.initweight !32, !taffo.info !37
...
for.body132:                                      ; preds = %for.cond129
  ...
  %arrayidx134 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom133, !taffo.initweight !51, !taffo.info !17
  %idxprom135 = sext i32 %j.4 to i64, !taffo.initweight !32, !taffo.info !33
  %arrayidx136 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx134, i64 0, i64 %idxprom135, !taffo.initweight !32, !taffo.info !17
...
for.cond137:                                      ; preds = %for.inc155, %for.body132
  ...
  %cmp138 = icmp slt i32 %k.0, 260, !taffo.initweight !32, !taffo.info !37
...
for.body140:                                      ; preds = %for.cond137
  ...
  %arrayidx142 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom141, !taffo.initweight !51, !taffo.info !9
  %idxprom143 = sext i32 %i.4 to i64, !taffo.initweight !32, !taffo.info !33
  %arrayidx144 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx142, i64 0, i64 %idxprom143, !taffo.initweight !32, !taffo.info !9
  ...
  %arrayidx146 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom145, !taffo.initweight !51, !taffo.info !9
  %idxprom147 = sext i32 %j.4 to i64, !taffo.initweight !32, !taffo.info !33
  %arrayidx148 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx146, i64 0, i64 %idxprom147, !taffo.initweight !32, !taffo.info !9
  %17 = load double, double* %arrayidx148, align 8, !taffo.initweight !34, !taffo.info !9
  %mul149 = fmul double %16, %17, !taffo.initweight !38, !taffo.info !77
  %idxprom150 = sext i32 %i.4 to i64, !taffo.initweight !32, !taffo.info !33
  %arrayidx151 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom150, !taffo.initweight !51, !taffo.info !17
  %idxprom152 = sext i32 %j.4 to i64, !taffo.initweight !32, !taffo.info !33
  %arrayidx153 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx151, i64 0, i64 %idxprom152, !taffo.initweight !32, !taffo.info !17
  %18 = load double, double* %arrayidx153, align 8, !taffo.initweight !34, !taffo.info !17
  %add154 = fadd double %18, %mul149, !taffo.initweight !38, !taffo.info !79
...
for.end157:                                       ; preds = %for.cond137
  ...
  %arrayidx159 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom158, !taffo.initweight !51, !taffo.info !17
  %idxprom160 = sext i32 %j.4 to i64, !taffo.initweight !32, !taffo.info !33
  %arrayidx161 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx159, i64 0, i64 %idxprom160, !taffo.initweight !32, !taffo.info !17
  ...
  %arrayidx163 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom162, !taffo.initweight !51, !taffo.info !17
  %idxprom164 = sext i32 %i.4 to i64, !taffo.initweight !32, !taffo.info !33
  %arrayidx165 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx163, i64 0, i64 %idxprom164, !taffo.initweight !32, !taffo.info !17
...
for.end171:                                       ; preds = %for.cond120
  store double 1.000000e+00, double* getelementptr inbounds ([240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 239, i64 239), align 8, !taffo.initweight !32, !taffo.info !17, !taffo.constinfo !74
...
for.cond172:                                      ; preds = %for.inc189, %for.end171
  ...
  %cmp173 = icmp slt i32 %i.5, 240, !taffo.initweight !32, !taffo.info !33
...
for.cond176:                                      ; preds = %for.inc185, %for.body175
  ...
  %cmp177 = icmp slt i32 %j.5, 240, !taffo.initweight !32, !taffo.info !37
...
for.body179:                                      ; preds = %for.cond176
  ...
  %arrayidx181 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom180, !taffo.initweight !51, !taffo.info !17
  %idxprom182 = sext i32 %j.5 to i64, !taffo.initweight !32, !taffo.info !37
  %arrayidx183 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx181, i64 0, i64 %idxprom182, !taffo.initweight !32, !taffo.info !17
...
; Function Attrs: nounwind
declare !taffo.initweight !81 !taffo.funinfo !82 void @llvm.var.annotation(i8*, i8*, i8*, i32) #3

; Function Attrs: nounwind
declare !taffo.initweight !83 !taffo.funinfo !84 dso_local double @sqrt(double) #1

declare !taffo.initweight !83 !taffo.funinfo !84 dso_local i32 @printf(i8*, ...) #2
...
!43 = !{double 2.400000e+02, double 2.400000e+02}
!44 = !{i1 false, !45, i1 false, i2 -1}
!45 = !{double 0.000000e+00, double 2.410000e+02}
!46 = !{i1 false, !47, i1 false, i2 -1}
!47 = !{double 0.000000e+00, double 0x3FEDA95A95A95A96}
!48 = !{i1 false, !49}
!49 = !{i1 false, !50, i1 false, i2 0}
!50 = !{double 2.600000e+02, double 2.600000e+02}
!51 = !{i32 1}
!52 = !{!0, i1 false}
!53 = !{i1 false, !54, !11, i2 -1}
!54 = !{double -5.001000e+04, double 5.001000e+04}
!55 = !{i1 false, !56, !11, i2 1}
!56 = !{double 0xC06809D89D89D89E, double 0x406809D89D89D89E}
...
!62 = !{double 0xC02F81F81F81F820, double 0x402F81F81F81F820}
!63 = !{i1 false, !64, !16, i2 -1}
!64 = !{double 0.000000e+00, double 6.400000e+01}
!65 = !{i1 false, !40, i1 false, i2 1}
!66 = !{i1 false, i1 false, i1 false, i2 1}
!67 = !{i1 false, !68, !11, i2 1}
!68 = !{double 0x40301FE03F61BAD0, double 0x40301FE03F61BAD0}
!69 = !{!49, i1 false}
!70 = !{i1 false, !71, !16, i2 -1}
!71 = !{double 0xC0F01FE03F61BAD0, double 0x40F01FE03F61BAD0}
!72 = !{i1 false, !73, !11, i2 -1}
!73 = !{double 0xBF23D87675649728, double 0x3F23D87675649728}
!74 = !{!75, i1 false}
