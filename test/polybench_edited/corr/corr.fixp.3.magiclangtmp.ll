...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  %cmp = icmp slt i32 %i.0, 32, !taffo.initweight !31, !taffo.info !32
...
for.cond5:                                        ; preds = %for.inc, %for.body
  ...
  %cmp6 = icmp slt i32 %j.0, 28, !taffo.initweight !31, !taffo.info !36
...
for.body7:                                        ; preds = %for.cond5
  ...
  %div = fdiv double %conv, 2.800000e+01, !taffo.initweight !37, !taffo.info !38, !taffo.constinfo !40
  ...
  %div9 = fdiv double %add, 3.200000e+01, !taffo.initweight !37, !taffo.info !45, !taffo.constinfo !47
  %idxprom = sext i32 %i.0 to i64, !taffo.initweight !31, !taffo.info !32
  %arrayidx = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom, !taffo.initweight !50, !taffo.info !9
  %idxprom10 = sext i32 %j.0 to i64, !taffo.initweight !31, !taffo.info !36
  %arrayidx11 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx, i64 0, i64 %idxprom10, !taffo.initweight !31, !taffo.info !9
...
for.cond16:                                       ; preds = %for.inc39, %for.end14
  ...
  %cmp17 = icmp slt i32 %j.1, 28, !taffo.initweight !31, !taffo.info !36
...
for.body19:                                       ; preds = %for.cond16
  ...
  %arrayidx21 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom20, !taffo.initweight !50, !taffo.info !12
...
for.cond22:                                       ; preds = %for.inc33, %for.body19
  ...
  %cmp23 = icmp slt i32 %i.1, 32, !taffo.initweight !31, !taffo.info !32
...
for.body25:                                       ; preds = %for.cond22
  ...
  %arrayidx27 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom26, !taffo.initweight !50, !taffo.info !9
  %idxprom28 = sext i32 %j.1 to i64, !taffo.initweight !31, !taffo.info !36
  %arrayidx29 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx27, i64 0, i64 %idxprom28, !taffo.initweight !31, !taffo.info !9
  ...
  %arrayidx31 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom30, !taffo.initweight !50, !taffo.info !12
...
for.end35:                                        ; preds = %for.cond22
  ...
  %arrayidx37 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom36, !taffo.initweight !50, !taffo.info !12
  %2 = load double, double* %arrayidx37, align 8, !taffo.initweight !31, !taffo.info !12
  %div38 = fdiv double %2, 3.200000e+01, !taffo.initweight !31, !taffo.info !54, !taffo.constinfo !47
...
for.cond42:                                       ; preds = %for.inc87, %for.end41
  ...
  %cmp43 = icmp slt i32 %j.2, 28, !taffo.initweight !31, !taffo.info !36
...
for.body45:                                       ; preds = %for.cond42
  ...
  %arrayidx47 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom46, !taffo.initweight !50, !taffo.info !14
...
for.cond48:                                       ; preds = %for.inc69, %for.body45
  ...
  %cmp49 = icmp slt i32 %i.2, 32, !taffo.initweight !31, !taffo.info !32
...
for.body51:                                       ; preds = %for.cond48
  ...
  %arrayidx53 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom52, !taffo.initweight !50, !taffo.info !9
  %idxprom54 = sext i32 %j.2 to i64, !taffo.initweight !31, !taffo.info !36
  %arrayidx55 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx53, i64 0, i64 %idxprom54, !taffo.initweight !31, !taffo.info !9
  ...
  %arrayidx57 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom56, !taffo.initweight !50, !taffo.info !12
  ...
  %arrayidx59 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom58, !taffo.initweight !50, !taffo.info !9
  %idxprom60 = sext i32 %j.2 to i64, !taffo.initweight !31, !taffo.info !36
  %arrayidx61 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx59, i64 0, i64 %idxprom60, !taffo.initweight !31, !taffo.info !9
  ...
  %arrayidx63 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom62, !taffo.initweight !50, !taffo.info !12
  ...
  %arrayidx67 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom66, !taffo.initweight !50, !taffo.info !14
...
for.end71:                                        ; preds = %for.cond48
  ...
  %arrayidx73 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom72, !taffo.initweight !50, !taffo.info !14
  %8 = load double, double* %arrayidx73, align 8, !taffo.initweight !31, !taffo.info !14
  %div74 = fdiv double %8, 3.200000e+01, !taffo.initweight !31, !taffo.info !60, !taffo.constinfo !47
  ...
  %arrayidx76 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom75, !taffo.initweight !50, !taffo.info !14
  ...
  %arrayidx78 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom77, !taffo.initweight !50, !taffo.info !14
  ...
  %arrayidx80 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom79, !taffo.initweight !50, !taffo.info !14
...
cond.false:                                       ; preds = %for.end71
  ...
  %arrayidx84 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom83, !taffo.initweight !50, !taffo.info !14
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %arrayidx86 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom85, !taffo.initweight !50, !taffo.info !14
...
for.cond90:                                       ; preds = %for.inc117, %for.end89
  ...
  %cmp91 = icmp slt i32 %i.3, 32, !taffo.initweight !31, !taffo.info !32
...
for.cond94:                                       ; preds = %for.inc114, %for.body93
  ...
  %cmp95 = icmp slt i32 %j.3, 28, !taffo.initweight !31, !taffo.info !36
...
for.body97:                                       ; preds = %for.cond94
  ...
  %arrayidx99 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom98, !taffo.initweight !50, !taffo.info !12
  ...
  %arrayidx101 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom100, !taffo.initweight !50, !taffo.info !9
  %idxprom102 = sext i32 %j.3 to i64, !taffo.initweight !31, !taffo.info !36
  %arrayidx103 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx101, i64 0, i64 %idxprom102, !taffo.initweight !31, !taffo.info !9
  ...
  %call105 = call double @sqrt(double 3.200000e+01) #3, !taffo.initweight !31, !taffo.info !67, !taffo.constinfo !69
  %idxprom106 = sext i32 %j.3 to i64, !taffo.initweight !31, !taffo.info !36
  %arrayidx107 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom106, !taffo.initweight !50, !taffo.info !14
  ...
  %arrayidx110 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom109, !taffo.initweight !50, !taffo.info !9
  %idxprom111 = sext i32 %j.3 to i64, !taffo.initweight !31, !taffo.info !36
  %arrayidx112 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx110, i64 0, i64 %idxprom111, !taffo.initweight !31, !taffo.info !9
...
for.cond120:                                      ; preds = %for.inc169, %for.end119
  ...
  %cmp121 = icmp slt i32 %i.4, 27, !taffo.initweight !31, !taffo.info !32
...
for.body123:                                      ; preds = %for.cond120
  ...
  %arrayidx125 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom124, !taffo.initweight !50, !taffo.info !17
  %idxprom126 = sext i32 %i.4 to i64, !taffo.initweight !31, !taffo.info !32
  %arrayidx127 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx125, i64 0, i64 %idxprom126, !taffo.initweight !31, !taffo.info !17
...
for.cond129:                                      ; preds = %for.inc166, %for.body123
  ...
  %cmp130 = icmp slt i32 %j.4, 28, !taffo.initweight !31, !taffo.info !36
...
for.body132:                                      ; preds = %for.cond129
  ...
  %arrayidx134 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom133, !taffo.initweight !50, !taffo.info !17
  %idxprom135 = sext i32 %j.4 to i64, !taffo.initweight !31, !taffo.info !32
  %arrayidx136 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx134, i64 0, i64 %idxprom135, !taffo.initweight !31, !taffo.info !17
...
for.cond137:                                      ; preds = %for.inc155, %for.body132
  ...
  %cmp138 = icmp slt i32 %k.0, 32, !taffo.initweight !31, !taffo.info !36
...
for.body140:                                      ; preds = %for.cond137
  ...
  %arrayidx142 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom141, !taffo.initweight !50, !taffo.info !9
  %idxprom143 = sext i32 %i.4 to i64, !taffo.initweight !31, !taffo.info !32
  %arrayidx144 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx142, i64 0, i64 %idxprom143, !taffo.initweight !31, !taffo.info !9
  ...
  %arrayidx146 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom145, !taffo.initweight !50, !taffo.info !9
  %idxprom147 = sext i32 %j.4 to i64, !taffo.initweight !31, !taffo.info !32
  %arrayidx148 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx146, i64 0, i64 %idxprom147, !taffo.initweight !31, !taffo.info !9
  ...
  %arrayidx151 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom150, !taffo.initweight !50, !taffo.info !17
  %idxprom152 = sext i32 %j.4 to i64, !taffo.initweight !31, !taffo.info !32
  %arrayidx153 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx151, i64 0, i64 %idxprom152, !taffo.initweight !31, !taffo.info !17
...
for.end157:                                       ; preds = %for.cond137
  ...
  %arrayidx159 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom158, !taffo.initweight !50, !taffo.info !17
  %idxprom160 = sext i32 %j.4 to i64, !taffo.initweight !31, !taffo.info !32
  %arrayidx161 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx159, i64 0, i64 %idxprom160, !taffo.initweight !31, !taffo.info !17
  ...
  %arrayidx163 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom162, !taffo.initweight !50, !taffo.info !17
  %idxprom164 = sext i32 %i.4 to i64, !taffo.initweight !31, !taffo.info !32
  %arrayidx165 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx163, i64 0, i64 %idxprom164, !taffo.initweight !31, !taffo.info !17
...
for.end171:                                       ; preds = %for.cond120
  store double 1.000000e+00, double* getelementptr inbounds ([28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 27, i64 27), align 8, !taffo.initweight !31, !taffo.info !17, !taffo.constinfo !74
...
for.cond172:                                      ; preds = %for.inc189, %for.end171
  ...
  %cmp173 = icmp slt i32 %i.5, 28, !taffo.initweight !31, !taffo.info !32
...
for.cond176:                                      ; preds = %for.inc185, %for.body175
  ...
  %cmp177 = icmp slt i32 %j.5, 28, !taffo.initweight !31, !taffo.info !36
...
for.body179:                                      ; preds = %for.cond176
  ...
  %arrayidx181 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom180, !taffo.initweight !50, !taffo.info !17
  %idxprom182 = sext i32 %j.5 to i64, !taffo.initweight !31, !taffo.info !36
  %arrayidx183 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx181, i64 0, i64 %idxprom182, !taffo.initweight !31, !taffo.info !17
...
!30 = !{double 0.000000e+00, double 2.400000e+02}
!31 = !{i32 2}
!32 = !{i1 false, !30, i1 false, i2 -1}
!33 = !{i32 3}
!34 = !{i1 false, !35, i1 false, i2 0}
!35 = !{double 0.000000e+00, double 2.600000e+02}
!36 = !{i1 false, !35, i1 false, i2 -1}
!37 = !{i32 4}
!38 = !{i1 false, !39, i1 false, i2 -1}
!39 = !{double 0.000000e+00, double 0x4021249249249249}
!40 = !{i1 false, !41}
!41 = !{i1 false, !42, i1 false, i2 0}
!42 = !{double 2.800000e+01, double 2.800000e+01}
!43 = !{i1 false, !44, i1 false, i2 -1}
!44 = !{double 0.000000e+00, double 0x406F124924924925}
!45 = !{i1 false, !46, i1 false, i2 -1}
!46 = !{double 0.000000e+00, double 0x401F124924924925}
!47 = !{i1 false, !48}
...
!55 = !{double -1.562500e+03, double 1.562500e+03}
...
!61 = !{double -1.280000e+02, double 1.280000e+02}
...
!68 = !{double 0x4016A09E667F3BCD, double 0x4016A09E667F3BCD}
!69 = !{!48, i1 false}
!70 = !{i1 false, !71, !16, i2 -1}
!71 = !{double 0xC0D6A09E667F3BCD, double 0x40D6A09E667F3BCD}
!72 = !{i1 false, !73, !11, i2 -1}
!73 = !{double 0xBF3C48C6001F0ABF, double 0x3F3C48C6001F0ABF}
!74 = !{!75, i1 false}
