...
# %bb.20:                               # %for.body55
	...
	shlq	$1, %rcx
	movslq	%edi, %rdx
	movslq	-7936(%rbp,%rdx,4), %rsi
	shlq	$13, %rsi
	addq	%rcx, %rsi
	sarq	$13, %rsi
	movl	%esi, %r8d
	movl	%r8d, -7936(%rbp,%rdx,4)
# %bb.21:                               # %for.inc73
                                        #   in Loop: Header=BB0_19 Depth=2
	movl	-7984(%rbp), %eax       # 4-byte Reload
	addl	$1, %eax
...
.LBB0_22:                               # %for.end75
	...
	movabsq	$5270498306774157605, %rsi # imm = 0x4924924924924925
	movq	%rdx, %rax
	imulq	%rsi
	movq	%rdx, %rax
	shrq	$63, %rax
	...
	shll	$5, %r8d
	sarl	$5, %r8d
	movl	%r8d, -7936(%rbp,%rcx,4)
	cvtsi2sdl	-7936(%rbp,%rcx,4), %xmm0
...
.LBB0_24:                               # %cond.false
	...
	movl	%edx, -7988(%rbp)       # 4-byte Spill
.LBB0_25:                               # %cond.end
                                        #   in Loop: Header=BB0_17 Depth=1
...
# %bb.31:                               # %for.body101
	...
	movl	-7996(%rbp), %esi       # 4-byte Reload
	movslq	%esi, %rdi
	shlq	$7, %rdi
...
# %bb.39:                               # %for.body136
	...
	xorl	%eax, %eax
	movl	-8012(%rbp), %ecx       # 4-byte Reload
	movslq	%ecx, %rdx
	shlq	$7, %rdx
	leaq	-7808(%rbp), %rsi
	addq	%rdx, %rsi
...
# %bb.41:                               # %for.body144
	...
	movq	%rdx, %rsi
	addq	%rcx, %rsi
	movl	-8012(%rbp), %edi       # 4-byte Reload
	movslq	%edi, %rcx
	movl	(%rsi,%rcx,4), %r8d
	movslq	%eax, %rcx
	shlq	$7, %rcx
	addq	%rcx, %rdx
	movl	-8020(%rbp), %r9d       # 4-byte Reload
	movslq	%r9d, %rcx
	movl	(%rdx,%rcx,4), %r10d
	movslq	%r8d, %rcx
	movslq	%r10d, %rdx
...
# %bb.51:                               # %for.body185
	...
	movl	-8044(%rbp), %edx       # 4-byte Reload
	movslq	%edx, %rsi
	movl	(%rcx,%rsi,4), %edi
	movl	%edi, %ecx
	cvtsi2sdq	%rcx, %xmm1
