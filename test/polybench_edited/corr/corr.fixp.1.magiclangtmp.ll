...
@data = common dso_local global [32 x [28 x double]] zeroinitializer, align 16
@.str.5 = private unnamed_addr constant [9 x i8] c"scalar()\00", section "llvm.metadata"
@mean = common dso_local global [28 x double] zeroinitializer, align 16
@stddev = common dso_local global [28 x double] zeroinitializer, align 16
@corr = common dso_local global [28 x [28 x double]] zeroinitializer, align 16
...
entry:
  ...
  store double 3.200000e+01, double* %float_n, align 8
...
for.body7:                                        ; preds = %for.cond5
  ...
  %div = fdiv double %conv, 2.800000e+01
  %4 = load i32, i32* %i, align 4
  %conv8 = sitofp i32 %4 to double
  %add = fadd double %div, %conv8
  %div9 = fdiv double %add, 3.200000e+01
  %5 = load i32, i32* %i, align 4
  %idxprom = sext i32 %5 to i64
  %arrayidx = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom
  %6 = load i32, i32* %j, align 4
  %idxprom10 = sext i32 %6 to i64
  %arrayidx11 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx, i64 0, i64 %idxprom10
...
for.cond16:                                       ; preds = %for.inc39, %for.end14
  ...
  %cmp17 = icmp slt i32 %9, 28
  br i1 %cmp17, label %for.body19, label %for.end41

for.body19:                                       ; preds = %for.cond16
  %10 = load i32, i32* %j, align 4
  %idxprom20 = sext i32 %10 to i64
  %arrayidx21 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom20
...
for.cond22:                                       ; preds = %for.inc33, %for.body19
  ...
  %cmp23 = icmp slt i32 %11, 32
  br i1 %cmp23, label %for.body25, label %for.end35

for.body25:                                       ; preds = %for.cond22
  %12 = load i32, i32* %i, align 4
  %idxprom26 = sext i32 %12 to i64
  %arrayidx27 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom26
  %13 = load i32, i32* %j, align 4
  %idxprom28 = sext i32 %13 to i64
  %arrayidx29 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx27, i64 0, i64 %idxprom28
  %14 = load double, double* %arrayidx29, align 8
  %15 = load i32, i32* %j, align 4
  %idxprom30 = sext i32 %15 to i64
  %arrayidx31 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom30
...
for.end35:                                        ; preds = %for.cond22
  ...
  %arrayidx37 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom36
...
for.cond42:                                       ; preds = %for.inc87, %for.end41
  ...
  %cmp43 = icmp slt i32 %22, 28
  br i1 %cmp43, label %for.body45, label %for.end89

for.body45:                                       ; preds = %for.cond42
  %23 = load i32, i32* %j, align 4
  %idxprom46 = sext i32 %23 to i64
  %arrayidx47 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom46
...
for.cond48:                                       ; preds = %for.inc69, %for.body45
  ...
  %cmp49 = icmp slt i32 %24, 32
  br i1 %cmp49, label %for.body51, label %for.end71

for.body51:                                       ; preds = %for.cond48
  %25 = load i32, i32* %i, align 4
  %idxprom52 = sext i32 %25 to i64
  %arrayidx53 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom52
  %26 = load i32, i32* %j, align 4
  %idxprom54 = sext i32 %26 to i64
  %arrayidx55 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx53, i64 0, i64 %idxprom54
  %27 = load double, double* %arrayidx55, align 8
  %28 = load i32, i32* %j, align 4
  %idxprom56 = sext i32 %28 to i64
  %arrayidx57 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom56
  %29 = load double, double* %arrayidx57, align 8
  %sub = fsub double %27, %29
  %30 = load i32, i32* %i, align 4
  %idxprom58 = sext i32 %30 to i64
  %arrayidx59 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom58
  %31 = load i32, i32* %j, align 4
  %idxprom60 = sext i32 %31 to i64
  %arrayidx61 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx59, i64 0, i64 %idxprom60
  %32 = load double, double* %arrayidx61, align 8
  %33 = load i32, i32* %j, align 4
  %idxprom62 = sext i32 %33 to i64
  %arrayidx63 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom62
  ...
  %arrayidx67 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom66
...
for.end71:                                        ; preds = %for.cond48
  ...
  %arrayidx73 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom72
  ...
  %arrayidx76 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom75
  %42 = load double, double* %arrayidx76, align 8
  %call = call double @sqrt(double %42) #3
  %43 = load i32, i32* %j, align 4
  %idxprom77 = sext i32 %43 to i64
  %arrayidx78 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom77
  store double %call, double* %arrayidx78, align 8
  %44 = load i32, i32* %j, align 4
  %idxprom79 = sext i32 %44 to i64
  %arrayidx80 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom79
...
cond.false:                                       ; preds = %for.end71
  ...
  %arrayidx84 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom83
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %arrayidx86 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom85
...
for.cond94:                                       ; preds = %for.inc114, %for.body93
  ...
  %cmp95 = icmp slt i32 %52, 28
  br i1 %cmp95, label %for.body97, label %for.end116

for.body97:                                       ; preds = %for.cond94
  %53 = load i32, i32* %j, align 4
  %idxprom98 = sext i32 %53 to i64
  %arrayidx99 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom98
  %54 = load double, double* %arrayidx99, align 8
  %55 = load i32, i32* %i, align 4
  %idxprom100 = sext i32 %55 to i64
  %arrayidx101 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom100
  %56 = load i32, i32* %j, align 4
  %idxprom102 = sext i32 %56 to i64
  %arrayidx103 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx101, i64 0, i64 %idxprom102
  ...
  %arrayidx107 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom106
  %60 = load double, double* %arrayidx107, align 8
  %mul108 = fmul double %call105, %60
  %61 = load i32, i32* %i, align 4
  %idxprom109 = sext i32 %61 to i64
  %arrayidx110 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom109
  %62 = load i32, i32* %j, align 4
  %idxprom111 = sext i32 %62 to i64
  %arrayidx112 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx110, i64 0, i64 %idxprom111
...
for.cond120:                                      ; preds = %for.inc169, %for.end119
  ...
  %cmp121 = icmp slt i32 %66, 27
  br i1 %cmp121, label %for.body123, label %for.end171

for.body123:                                      ; preds = %for.cond120
  %67 = load i32, i32* %i, align 4
  %idxprom124 = sext i32 %67 to i64
  %arrayidx125 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom124
  %68 = load i32, i32* %i, align 4
  %idxprom126 = sext i32 %68 to i64
  %arrayidx127 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx125, i64 0, i64 %idxprom126
...
for.cond129:                                      ; preds = %for.inc166, %for.body123
  ...
  %cmp130 = icmp slt i32 %70, 28
  br i1 %cmp130, label %for.body132, label %for.end168

for.body132:                                      ; preds = %for.cond129
  %71 = load i32, i32* %i, align 4
  %idxprom133 = sext i32 %71 to i64
  %arrayidx134 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom133
  %72 = load i32, i32* %j, align 4
  %idxprom135 = sext i32 %72 to i64
  %arrayidx136 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx134, i64 0, i64 %idxprom135
...
for.cond137:                                      ; preds = %for.inc155, %for.body132
  ...
  %cmp138 = icmp slt i32 %73, 32
  br i1 %cmp138, label %for.body140, label %for.end157

for.body140:                                      ; preds = %for.cond137
  %74 = load i32, i32* %k, align 4
  %idxprom141 = sext i32 %74 to i64
  %arrayidx142 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom141
  %75 = load i32, i32* %i, align 4
  %idxprom143 = sext i32 %75 to i64
  %arrayidx144 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx142, i64 0, i64 %idxprom143
  %76 = load double, double* %arrayidx144, align 8
  %77 = load i32, i32* %k, align 4
  %idxprom145 = sext i32 %77 to i64
  %arrayidx146 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom145
  %78 = load i32, i32* %j, align 4
  %idxprom147 = sext i32 %78 to i64
  %arrayidx148 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx146, i64 0, i64 %idxprom147
  %79 = load double, double* %arrayidx148, align 8
  %mul149 = fmul double %76, %79
  %80 = load i32, i32* %i, align 4
  %idxprom150 = sext i32 %80 to i64
  %arrayidx151 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom150
  %81 = load i32, i32* %j, align 4
  %idxprom152 = sext i32 %81 to i64
  %arrayidx153 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx151, i64 0, i64 %idxprom152
...
for.end157:                                       ; preds = %for.cond137
  ...
  %arrayidx159 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom158
  %85 = load i32, i32* %j, align 4
  %idxprom160 = sext i32 %85 to i64
  %arrayidx161 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx159, i64 0, i64 %idxprom160
  %86 = load double, double* %arrayidx161, align 8
  %87 = load i32, i32* %j, align 4
  %idxprom162 = sext i32 %87 to i64
  %arrayidx163 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom162
  %88 = load i32, i32* %i, align 4
  %idxprom164 = sext i32 %88 to i64
  %arrayidx165 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx163, i64 0, i64 %idxprom164
...
for.end171:                                       ; preds = %for.cond120
  store double 1.000000e+00, double* getelementptr inbounds ([28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 27, i64 27), align 8
...
for.cond176:                                      ; preds = %for.inc185, %for.body175
  ...
  %cmp177 = icmp slt i32 %92, 28
  br i1 %cmp177, label %for.body179, label %for.end187

for.body179:                                      ; preds = %for.cond176
  %93 = load i32, i32* %i, align 4
  %idxprom180 = sext i32 %93 to i64
  %arrayidx181 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom180
  %94 = load i32, i32* %j, align 4
  %idxprom182 = sext i32 %94 to i64
  %arrayidx183 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx181, i64 0, i64 %idxprom182
