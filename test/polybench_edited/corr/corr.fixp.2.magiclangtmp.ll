...
@stddev = common dso_local global [28 x double] zeroinitializer, align 16, !taffo.initweight !0, !taffo.info !6
@corr = common dso_local global [28 x [28 x double]] zeroinitializer, align 16, !taffo.initweight !0, !taffo.info !9
...
entry:
  ...
  store double 3.200000e+01, double* %float_n, align 8, !taffo.initweight !23, !taffo.info !20
...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  %cmp = icmp slt i32 %0, 32, !taffo.initweight !24, !taffo.info !16
...
for.cond5:                                        ; preds = %for.inc, %for.body
  ...
  %cmp6 = icmp slt i32 %1, 28, !taffo.initweight !24, !taffo.info !18
...
for.body7:                                        ; preds = %for.cond5
  ...
  %div = fdiv double %conv, 2.800000e+01, !taffo.initweight !26, !taffo.info !16
  ...
  %div9 = fdiv double %add, 3.200000e+01, !taffo.initweight !26, !taffo.info !16
  %5 = load i32, i32* %i, align 4, !taffo.initweight !23, !taffo.info !16
  %idxprom = sext i32 %5 to i64, !taffo.initweight !24, !taffo.info !16
  %arrayidx = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom, !taffo.initweight !23, !taffo.info !1
  %6 = load i32, i32* %j, align 4, !taffo.initweight !23, !taffo.info !18
  %idxprom10 = sext i32 %6 to i64, !taffo.initweight !24, !taffo.info !18
  %arrayidx11 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx, i64 0, i64 %idxprom10, !taffo.initweight !24, !taffo.info !1
...
for.cond16:                                       ; preds = %for.inc39, %for.end14
  ...
  %cmp17 = icmp slt i32 %9, 28, !taffo.initweight !24, !taffo.info !18
...
for.body19:                                       ; preds = %for.cond16
  ...
  %arrayidx21 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom20, !taffo.initweight !23, !taffo.info !4
...
for.cond22:                                       ; preds = %for.inc33, %for.body19
  ...
  %cmp23 = icmp slt i32 %11, 32, !taffo.initweight !24, !taffo.info !16
...
for.body25:                                       ; preds = %for.cond22
  ...
  %arrayidx27 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom26, !taffo.initweight !23, !taffo.info !1
  ...
  %arrayidx29 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx27, i64 0, i64 %idxprom28, !taffo.initweight !24, !taffo.info !1
  ...
  %arrayidx31 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom30, !taffo.initweight !23, !taffo.info !4
...
for.end35:                                        ; preds = %for.cond22
  ...
  %arrayidx37 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom36, !taffo.initweight !23, !taffo.info !4
...
for.cond42:                                       ; preds = %for.inc87, %for.end41
  ...
  %cmp43 = icmp slt i32 %22, 28, !taffo.initweight !24, !taffo.info !18
...
for.body45:                                       ; preds = %for.cond42
  ...
  %arrayidx47 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom46, !taffo.initweight !23, !taffo.info !6
...
for.cond48:                                       ; preds = %for.inc69, %for.body45
  ...
  %cmp49 = icmp slt i32 %24, 32, !taffo.initweight !24, !taffo.info !16
...
for.body51:                                       ; preds = %for.cond48
  ...
  %arrayidx53 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom52, !taffo.initweight !23, !taffo.info !1
  ...
  %arrayidx55 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx53, i64 0, i64 %idxprom54, !taffo.initweight !24, !taffo.info !1
  ...
  %arrayidx57 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom56, !taffo.initweight !23, !taffo.info !4
  ...
  %arrayidx59 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom58, !taffo.initweight !23, !taffo.info !1
  ...
  %arrayidx61 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx59, i64 0, i64 %idxprom60, !taffo.initweight !24, !taffo.info !1
  ...
  %arrayidx63 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom62, !taffo.initweight !23, !taffo.info !4
  ...
  %arrayidx67 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom66, !taffo.initweight !23, !taffo.info !6
...
for.end71:                                        ; preds = %for.cond48
  ...
  %arrayidx73 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom72, !taffo.initweight !23, !taffo.info !6
  ...
  %arrayidx76 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom75, !taffo.initweight !23, !taffo.info !6
  ...
  %arrayidx78 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom77, !taffo.initweight !23, !taffo.info !6
  ...
  %arrayidx80 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom79, !taffo.initweight !23, !taffo.info !6
...
cond.false:                                       ; preds = %for.end71
  ...
  %arrayidx84 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom83, !taffo.initweight !23, !taffo.info !6
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %arrayidx86 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom85, !taffo.initweight !23, !taffo.info !6
...
for.cond90:                                       ; preds = %for.inc117, %for.end89
  ...
  %cmp91 = icmp slt i32 %51, 32, !taffo.initweight !24, !taffo.info !16
...
for.cond94:                                       ; preds = %for.inc114, %for.body93
  ...
  %cmp95 = icmp slt i32 %52, 28, !taffo.initweight !24, !taffo.info !18
...
for.body97:                                       ; preds = %for.cond94
  ...
  %arrayidx99 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom98, !taffo.initweight !23, !taffo.info !4
  ...
  %arrayidx101 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom100, !taffo.initweight !23, !taffo.info !1
  ...
  %arrayidx103 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx101, i64 0, i64 %idxprom102, !taffo.initweight !24, !taffo.info !1
  ...
  %arrayidx107 = getelementptr inbounds [28 x double], [28 x double]* @stddev, i64 0, i64 %idxprom106, !taffo.initweight !23, !taffo.info !6
  ...
  %arrayidx110 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom109, !taffo.initweight !23, !taffo.info !1
  ...
  %arrayidx112 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx110, i64 0, i64 %idxprom111, !taffo.initweight !24, !taffo.info !1
...
for.cond120:                                      ; preds = %for.inc169, %for.end119
  ...
  %cmp121 = icmp slt i32 %66, 27, !taffo.initweight !24, !taffo.info !16
...
for.body123:                                      ; preds = %for.cond120
  ...
  %arrayidx125 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom124, !taffo.initweight !23, !taffo.info !9
  ...
  %arrayidx127 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx125, i64 0, i64 %idxprom126, !taffo.initweight !24, !taffo.info !9
...
for.cond129:                                      ; preds = %for.inc166, %for.body123
  ...
  %cmp130 = icmp slt i32 %70, 28, !taffo.initweight !24, !taffo.info !18
...
for.body132:                                      ; preds = %for.cond129
  ...
  %arrayidx134 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom133, !taffo.initweight !23, !taffo.info !9
  ...
  %arrayidx136 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx134, i64 0, i64 %idxprom135, !taffo.initweight !24, !taffo.info !9
...
for.cond137:                                      ; preds = %for.inc155, %for.body132
  ...
  %cmp138 = icmp slt i32 %73, 32, !taffo.initweight !24, !taffo.info !18
...
for.body140:                                      ; preds = %for.cond137
  ...
  %arrayidx142 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom141, !taffo.initweight !23, !taffo.info !1
  ...
  %arrayidx144 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx142, i64 0, i64 %idxprom143, !taffo.initweight !24, !taffo.info !1
  ...
  %arrayidx146 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom145, !taffo.initweight !23, !taffo.info !1
  ...
  %arrayidx148 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx146, i64 0, i64 %idxprom147, !taffo.initweight !24, !taffo.info !1
  ...
  %arrayidx151 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom150, !taffo.initweight !23, !taffo.info !9
  ...
  %arrayidx153 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx151, i64 0, i64 %idxprom152, !taffo.initweight !24, !taffo.info !9
...
for.end157:                                       ; preds = %for.cond137
  ...
  %arrayidx159 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom158, !taffo.initweight !23, !taffo.info !9
  ...
  %arrayidx161 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx159, i64 0, i64 %idxprom160, !taffo.initweight !24, !taffo.info !9
  ...
  %arrayidx163 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom162, !taffo.initweight !23, !taffo.info !9
  ...
  %arrayidx165 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx163, i64 0, i64 %idxprom164, !taffo.initweight !24, !taffo.info !9
...
for.end171:                                       ; preds = %for.cond120
  store double 1.000000e+00, double* getelementptr inbounds ([28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 27, i64 27), align 8, !taffo.initweight !24, !taffo.info !9
...
for.cond172:                                      ; preds = %for.inc189, %for.end171
  ...
  %cmp173 = icmp slt i32 %91, 28, !taffo.initweight !24, !taffo.info !16
...
for.cond176:                                      ; preds = %for.inc185, %for.body175
  ...
  %cmp177 = icmp slt i32 %92, 28, !taffo.initweight !24, !taffo.info !18
...
for.body179:                                      ; preds = %for.cond176
  ...
  %arrayidx181 = getelementptr inbounds [28 x [28 x double]], [28 x [28 x double]]* @corr, i64 0, i64 %idxprom180, !taffo.initweight !23, !taffo.info !9
  ...
  %arrayidx183 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx181, i64 0, i64 %idxprom182, !taffo.initweight !24, !taffo.info !9
