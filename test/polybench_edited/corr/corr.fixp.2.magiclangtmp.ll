...
for.body185:                                      ; preds = %for.cond182
  ...
  %call190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.9, i32 0, i32 0), double %95), !taffo.initweight !23, !taffo.info !9
  br label %for.inc191
...
!7 = !{i1 false, !8, !6, i2 -1}
!8 = !{double -5.000000e-01, double 5.000000e-01}
