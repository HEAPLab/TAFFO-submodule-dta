...
@stddev = common dso_local global [240 x double] zeroinitializer, align 16, !taffo.info !14, !taffo.initweight !10
@corr = common dso_local global [240 x [240 x double]] zeroinitializer, align 16, !taffo.info !18, !taffo.initweight !10
...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  %cmp = icmp slt i32 %i.0, 260, !taffo.info !36, !taffo.initweight !37
...
for.cond5:                                        ; preds = %for.inc, %for.body
  ...
  %cmp6 = icmp slt i32 %j.0, 240, !taffo.info !41, !taffo.initweight !37
...
for.body7:                                        ; preds = %for.cond5
  ...
  %div = fdiv double %conv, 2.400000e+02, !taffo.info !44, !taffo.initweight !47, !taffo.constinfo !48
  ...
  %div9 = fdiv double %add, 2.600000e+02, !taffo.info !53, !taffo.initweight !47, !taffo.constinfo !55
  %idxprom = sext i32 %i.0 to i64, !taffo.info !36, !taffo.initweight !37
  %arrayidx = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom, !taffo.info !6, !taffo.initweight !58
  %idxprom10 = sext i32 %j.0 to i64, !taffo.info !41, !taffo.initweight !37
  %arrayidx11 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx, i64 0, i64 %idxprom10, !taffo.info !6, !taffo.initweight !37
...
for.cond16:                                       ; preds = %for.inc39, %for.end14
  ...
  %cmp17 = icmp slt i32 %j.1, 240, !taffo.info !41, !taffo.initweight !37
...
for.body19:                                       ; preds = %for.cond16
  ...
  %arrayidx21 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom20, !taffo.info !11, !taffo.initweight !58
...
for.cond22:                                       ; preds = %for.inc33, %for.body19
  ...
  %cmp23 = icmp slt i32 %i.1, 260, !taffo.info !36, !taffo.initweight !37
...
for.body25:                                       ; preds = %for.cond22
  ...
  %arrayidx27 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom26, !taffo.info !6, !taffo.initweight !58
  %idxprom28 = sext i32 %j.1 to i64, !taffo.info !41, !taffo.initweight !37
  %arrayidx29 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx27, i64 0, i64 %idxprom28, !taffo.info !6, !taffo.initweight !37
  ...
  %arrayidx31 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom30, !taffo.info !11, !taffo.initweight !58
...
for.end35:                                        ; preds = %for.cond22
  ...
  %arrayidx37 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom36, !taffo.info !11, !taffo.initweight !58
  %tmp2 = load double, double* %arrayidx37, align 8, !taffo.info !11, !taffo.initweight !37
  %div38 = fdiv double %tmp2, 2.600000e+02, !taffo.info !64, !taffo.initweight !37, !taffo.constinfo !55
...
for.cond42:                                       ; preds = %for.inc87, %for.end41
  ...
  %cmp43 = icmp slt i32 %j.2, 240, !taffo.info !41, !taffo.initweight !37
...
for.body45:                                       ; preds = %for.cond42
  ...
  %arrayidx47 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom46, !taffo.info !14, !taffo.initweight !58
...
for.cond48:                                       ; preds = %for.inc69, %for.body45
  ...
  %cmp49 = icmp slt i32 %i.2, 260, !taffo.info !36, !taffo.initweight !37
...
for.body51:                                       ; preds = %for.cond48
  ...
  %arrayidx53 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom52, !taffo.info !6, !taffo.initweight !58
  %idxprom54 = sext i32 %j.2 to i64, !taffo.info !41, !taffo.initweight !37
  %arrayidx55 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx53, i64 0, i64 %idxprom54, !taffo.info !6, !taffo.initweight !37
  ...
  %arrayidx57 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom56, !taffo.info !11, !taffo.initweight !58
  ...
  %arrayidx59 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom58, !taffo.info !6, !taffo.initweight !58
  %idxprom60 = sext i32 %j.2 to i64, !taffo.info !41, !taffo.initweight !37
  %arrayidx61 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx59, i64 0, i64 %idxprom60, !taffo.info !6, !taffo.initweight !37
  ...
  %arrayidx63 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom62, !taffo.info !11, !taffo.initweight !58
  ...
  %arrayidx67 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom66, !taffo.info !14, !taffo.initweight !58
...
for.end71:                                        ; preds = %for.cond48
  ...
  %arrayidx73 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom72, !taffo.info !14, !taffo.initweight !58
  %tmp8 = load double, double* %arrayidx73, align 8, !taffo.info !14, !taffo.initweight !37
  %div74 = fdiv double %tmp8, 2.600000e+02, !taffo.info !73, !taffo.initweight !37, !taffo.constinfo !55
  ...
  %arrayidx76 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom75, !taffo.info !14, !taffo.initweight !58
  ...
  %arrayidx78 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom77, !taffo.info !14, !taffo.initweight !58
  ...
  %arrayidx80 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom79, !taffo.info !14, !taffo.initweight !58
...
cond.false:                                       ; preds = %for.end71
  ...
  %arrayidx84 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom83, !taffo.info !14, !taffo.initweight !58
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %arrayidx86 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom85, !taffo.info !14, !taffo.initweight !58
...
for.cond90:                                       ; preds = %for.inc117, %for.end89
  ...
  %cmp91 = icmp slt i32 %i.3, 260, !taffo.info !36, !taffo.initweight !37
...
for.cond94:                                       ; preds = %for.inc114, %for.body93
  ...
  %cmp95 = icmp slt i32 %j.3, 240, !taffo.info !41, !taffo.initweight !37
...
for.body97:                                       ; preds = %for.cond94
  ...
  %arrayidx99 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom98, !taffo.info !11, !taffo.initweight !58
  ...
  %arrayidx101 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom100, !taffo.info !6, !taffo.initweight !58
  %idxprom102 = sext i32 %j.3 to i64, !taffo.info !41, !taffo.initweight !37
  %arrayidx103 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx101, i64 0, i64 %idxprom102, !taffo.info !6, !taffo.initweight !37
  ...
  %call105 = call double @sqrt(double 2.600000e+02) #3, !taffo.info !81, !taffo.initweight !37, !taffo.constinfo !84
  %idxprom106 = sext i32 %j.3 to i64, !taffo.info !41, !taffo.initweight !37
  %arrayidx107 = getelementptr inbounds [240 x double], [240 x double]* @stddev, i64 0, i64 %idxprom106, !taffo.info !14, !taffo.initweight !58
  %tmp14 = load double, double* %arrayidx107, align 8, !taffo.info !14, !taffo.initweight !37
  %mul108 = fmul double %call105, %tmp14, !taffo.info !85, !taffo.initweight !38
  %idxprom109 = sext i32 %i.3 to i64, !taffo.info !36, !taffo.initweight !37
  %arrayidx110 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom109, !taffo.info !6, !taffo.initweight !58
  %idxprom111 = sext i32 %j.3 to i64, !taffo.info !41, !taffo.initweight !37
  %arrayidx112 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx110, i64 0, i64 %idxprom111, !taffo.info !6, !taffo.initweight !37
...
for.cond120:                                      ; preds = %for.inc169, %for.end119
  ...
  %cmp121 = icmp slt i32 %i.4, 239, !taffo.info !36, !taffo.initweight !37
...
for.body123:                                      ; preds = %for.cond120
  ...
  %arrayidx125 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom124, !taffo.info !18, !taffo.initweight !58
  %idxprom126 = sext i32 %i.4 to i64, !taffo.info !36, !taffo.initweight !37
  %arrayidx127 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx125, i64 0, i64 %idxprom126, !taffo.info !18, !taffo.initweight !37
...
for.cond129:                                      ; preds = %for.inc166, %for.body123
  ...
  %cmp130 = icmp slt i32 %j.4, 240, !taffo.info !41, !taffo.initweight !37
...
for.body132:                                      ; preds = %for.cond129
  ...
  %arrayidx134 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom133, !taffo.info !18, !taffo.initweight !58
  %idxprom135 = sext i32 %j.4 to i64, !taffo.info !36, !taffo.initweight !37
  %arrayidx136 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx134, i64 0, i64 %idxprom135, !taffo.info !18, !taffo.initweight !37
...
for.cond137:                                      ; preds = %for.inc155, %for.body132
  ...
  %cmp138 = icmp slt i32 %k.0, 260, !taffo.info !41, !taffo.initweight !37
...
for.body140:                                      ; preds = %for.cond137
  ...
  %arrayidx142 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom141, !taffo.info !6, !taffo.initweight !58
  %idxprom143 = sext i32 %i.4 to i64, !taffo.info !36, !taffo.initweight !37
  %arrayidx144 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx142, i64 0, i64 %idxprom143, !taffo.info !6, !taffo.initweight !37
  ...
  %arrayidx146 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom145, !taffo.info !6, !taffo.initweight !58
  %idxprom147 = sext i32 %j.4 to i64, !taffo.info !36, !taffo.initweight !37
  %arrayidx148 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx146, i64 0, i64 %idxprom147, !taffo.info !6, !taffo.initweight !37
  ...
  %arrayidx151 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom150, !taffo.info !18, !taffo.initweight !58
  %idxprom152 = sext i32 %j.4 to i64, !taffo.info !36, !taffo.initweight !37
  %arrayidx153 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx151, i64 0, i64 %idxprom152, !taffo.info !18, !taffo.initweight !37
...
for.end157:                                       ; preds = %for.cond137
  ...
  %arrayidx159 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom158, !taffo.info !18, !taffo.initweight !58
  %idxprom160 = sext i32 %j.4 to i64, !taffo.info !36, !taffo.initweight !37
  %arrayidx161 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx159, i64 0, i64 %idxprom160, !taffo.info !18, !taffo.initweight !37
  ...
  %arrayidx163 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom162, !taffo.info !18, !taffo.initweight !58
  %idxprom164 = sext i32 %i.4 to i64, !taffo.info !36, !taffo.initweight !37
  %arrayidx165 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx163, i64 0, i64 %idxprom164, !taffo.info !18, !taffo.initweight !37
...
for.end171:                                       ; preds = %for.cond120
  store double 1.000000e+00, double* getelementptr inbounds ([240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 239, i64 239), align 8, !taffo.info !91, !taffo.initweight !37, !taffo.constinfo !92
...
for.cond172:                                      ; preds = %for.inc189, %for.end171
  ...
  %cmp173 = icmp slt i32 %i.5, 240, !taffo.info !36, !taffo.initweight !37
...
for.cond176:                                      ; preds = %for.inc185, %for.body175
  ...
  %cmp177 = icmp slt i32 %j.5, 240, !taffo.info !41, !taffo.initweight !37
...
for.body179:                                      ; preds = %for.cond176
  ...
  %arrayidx181 = getelementptr inbounds [240 x [240 x double]], [240 x [240 x double]]* @corr, i64 0, i64 %idxprom180, !taffo.info !18, !taffo.initweight !58
  %idxprom182 = sext i32 %j.5 to i64, !taffo.info !41, !taffo.initweight !37
  %arrayidx183 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx181, i64 0, i64 %idxprom182, !taffo.info !18, !taffo.initweight !37
...
!50 = !{double 2.400000e+02, double 2.400000e+02}
!51 = !{!43, !52, i1 false, i2 -1}
!52 = !{double 0.000000e+00, double 2.410000e+02}
!53 = !{!45, !54, i1 false, i2 -1}
!54 = !{double 0.000000e+00, double 0x3FEDA95A95A95A96}
!55 = !{i1 false, !56}
!56 = !{i1 false, !57, i1 false, i2 0}
!57 = !{double 2.600000e+02, double 2.600000e+02}
!58 = !{i32 1}
...
!64 = !{!65, !66, !9, i2 1}
!65 = !{!"fixp", i32 -32, i32 23}
!66 = !{double 0xC06809D89D89D89E, double 0x406809D89D89D89E}
...
!75 = !{double 0xC02F81F81F81F820, double 0x402F81F81F81F820}
!76 = !{!77, !78, !17, i2 -1}
...
!81 = !{!82, !83, !9, i2 1}
!82 = !{!"fixp", i32 32, i32 27}
!83 = !{double 0x40301FE03F61BAD0, double 0x40301FE03F61BAD0}
!84 = !{!56, i1 false}
!85 = !{!86, !87, !17, i2 -1}
!86 = !{!"fixp", i32 -32, i32 14}
!87 = !{double 0xC0F01FE03F61BAD0, double 0x40F01FE03F61BAD0}
!88 = !{!89, !90, !9, i2 -1}
!89 = !{!"fixp", i32 -32, i32 30}
!90 = !{double 0xBF23D87675649728, double 0x3F23D87675649728}
