...
for.body11:                                       ; preds = %for.cond9
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !28, !taffo.initweight !29
  %conv = sitofp i32 %mul to double, !taffo.info !28, !taffo.initweight !30
  %div = fdiv double %conv, 3.200000e+01, !taffo.info !34, !taffo.initweight !36, !taffo.constinfo !37
  %conv12 = sitofp i32 %i.0 to double, !taffo.info !28, !taffo.initweight !29
  %add = fadd double %div, %conv12, !taffo.info !40, !taffo.initweight !30
  %div13 = fdiv double %add, 2.800000e+01, !taffo.info !42, !taffo.initweight !36, !taffo.constinfo !44
  %idxprom = sext i32 %i.0 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  %idxprom14 = sext i32 %j.0 to i64, !taffo.info !33, !taffo.initweight !29
  %arrayidx15 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx, i64 0, i64 %idxprom14, !taffo.info !12, !taffo.initweight !29
  store double %div13, double* %arrayidx15, align 8, !taffo.info !47, !taffo.initweight !30
  br label %for.inc

for.inc:                                          ; preds = %for.body11
  %inc = add nsw i32 %j.0, 1, !taffo.info !33, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond9
...
for.inc16:                                        ; preds = %for.end
  %inc17 = add nsw i32 %i.0, 1, !taffo.info !28, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond
...
for.body29:                                       ; preds = %for.cond26
  %idxprom30 = sext i32 %i.1 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  %add36 = fadd double %tmp1, %tmp, !taffo.info !53, !taffo.initweight !30
  store double %add36, double* %arrayidx35, align 8, !taffo.info !49, !taffo.initweight !29
  br label %for.inc37

for.inc37:                                        ; preds = %for.body29
  %inc38 = add nsw i32 %i.1, 1, !taffo.info !28, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond26

for.end39:                                        ; preds = %for.cond26
  %idxprom40 = sext i32 %j.1 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %div42 = fdiv double %tmp2, 2.800000e+01, !taffo.info !55, !taffo.initweight !29, !taffo.constinfo !44
  store double %div42, double* %arrayidx41, align 8, !taffo.info !49, !taffo.initweight !29
  br label %for.inc43

for.inc43:                                        ; preds = %for.end39
  %inc44 = add nsw i32 %j.1, 1, !taffo.info !33, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond20
...
for.body49:                                       ; preds = %for.cond46
  %idxprom50 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
  %arrayidx51 = getelementptr inbounds [32 x double], [32 x double]* %stddev, i64 0, i64 %idxprom50, !taffo.info !18, !taffo.initweight !22
  store double 0.000000e+00, double* %arrayidx51, align 8, !taffo.info !58, !taffo.initweight !29, !taffo.constinfo !50
  br label %for.cond52
...
for.body55:                                       ; preds = %for.cond52
  %idxprom56 = sext i32 %i.2 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  %idxprom58 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %idxprom60 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %sub = fsub double %tmp3, %tmp4, !taffo.info !53, !taffo.initweight !30
  %idxprom62 = sext i32 %i.2 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  %idxprom64 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %idxprom66 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %sub68 = fsub double %tmp5, %tmp6, !taffo.info !53, !taffo.initweight !30
  %mul69 = fmul double %sub, %sub68, !taffo.info !59, !taffo.initweight !36
  %idxprom70 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %add72 = fadd double %tmp7, %mul69, !taffo.info !62, !taffo.initweight !30
  store double %add72, double* %arrayidx71, align 8, !taffo.info !58, !taffo.initweight !29
  br label %for.inc73

for.inc73:                                        ; preds = %for.body55
  %inc74 = add nsw i32 %i.2, 1, !taffo.info !28, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond52

for.end75:                                        ; preds = %for.cond52
  %idxprom76 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %div78 = fdiv double %tmp8, 2.800000e+01, !taffo.info !64, !taffo.initweight !29, !taffo.constinfo !44
  store double %div78, double* %arrayidx77, align 8, !taffo.info !58, !taffo.initweight !29
  %idxprom79 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %call = call double @sqrt(double %tmp9) #3, !taffo.info !67, !taffo.initweight !30, !taffo.constinfo !48
  %idxprom81 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
  %arrayidx82 = getelementptr inbounds [32 x double], [32 x double]* %stddev, i64 0, i64 %idxprom81, !taffo.info !18, !taffo.initweight !22
  store double %call, double* %arrayidx82, align 8, !taffo.info !58, !taffo.initweight !29
  %idxprom83 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  br i1 %cmp85, label %cond.true, label %cond.false, !taffo.info !70, !taffo.initweight !30

cond.true:                                        ; preds = %for.end75
  br label %cond.end

cond.false:                                       ; preds = %for.end75
  %idxprom87 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %idxprom89 = sext i32 %j.2 to i64, !taffo.info !33, !taffo.initweight !29
  %arrayidx90 = getelementptr inbounds [32 x double], [32 x double]* %stddev, i64 0, i64 %idxprom89, !taffo.info !18, !taffo.initweight !22
  store double %cond, double* %arrayidx90, align 8, !taffo.info !58, !taffo.initweight !29
  br label %for.inc91

for.inc91:                                        ; preds = %cond.end
  %inc92 = add nsw i32 %j.2, 1, !taffo.info !33, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond46
...
for.body101:                                      ; preds = %for.cond98
  %idxprom102 = sext i32 %j.3 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %idxprom104 = sext i32 %i.3 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  %idxprom106 = sext i32 %j.3 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %sub108 = fsub double %tmp13, %tmp12, !taffo.info !53, !taffo.initweight !30
  store double %sub108, double* %arrayidx107, align 8, !taffo.info !47, !taffo.initweight !30
  %call109 = call double @sqrt(double 2.800000e+01) #3, !taffo.info !71, !taffo.initweight !29, !taffo.constinfo !73
  %idxprom110 = sext i32 %j.3 to i64, !taffo.info !33, !taffo.initweight !29
  %arrayidx111 = getelementptr inbounds [32 x double], [32 x double]* %stddev, i64 0, i64 %idxprom110, !taffo.info !18, !taffo.initweight !22
  %tmp14 = load double, double* %arrayidx111, align 8, !taffo.info !74, !taffo.initweight !29
  %mul112 = fmul double %call109, %tmp14, !taffo.info !76, !taffo.initweight !30
  %idxprom113 = sext i32 %i.3 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  %idxprom115 = sext i32 %j.3 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %div117 = fdiv double %tmp15, %mul112, !taffo.info !78, !taffo.initweight !36
  store double %div117, double* %arrayidx116, align 8, !taffo.info !47, !taffo.initweight !30
  br label %for.inc118

for.inc118:                                       ; preds = %for.body101
  %inc119 = add nsw i32 %j.3, 1, !taffo.info !33, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond98
...
for.inc121:                                       ; preds = %for.end120
  %inc122 = add nsw i32 %i.3, 1, !taffo.info !28, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond94
...
for.body127:                                      ; preds = %for.cond124
  %idxprom128 = sext i32 %i.4 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  %idxprom130 = sext i32 %i.4 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  store double 1.000000e+00, double* %arrayidx131, align 8, !taffo.info !81, !taffo.initweight !30, !taffo.constinfo !82
  %add132 = add nsw i32 %i.4, 1, !taffo.info !28, !taffo.initweight !29, !taffo.constinfo !48
...
for.body136:                                      ; preds = %for.cond133
  %idxprom137 = sext i32 %i.4 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  store double 0.000000e+00, double* %arrayidx140, align 8, !taffo.info !81, !taffo.initweight !30, !taffo.constinfo !50
...
for.body144:                                      ; preds = %for.cond141
  %idxprom145 = sext i32 %k.0 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %idxprom147 = sext i32 %i.4 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  %idxprom149 = sext i32 %k.0 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %mul153 = fmul double %tmp16, %tmp17, !taffo.info !85, !taffo.initweight !36
  %idxprom154 = sext i32 %i.4 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  %add158 = fadd double %tmp18, %mul153, !taffo.info !88, !taffo.initweight !36
  store double %add158, double* %arrayidx157, align 8, !taffo.info !81, !taffo.initweight !30
  br label %for.inc159

for.inc159:                                       ; preds = %for.body144
  %inc160 = add nsw i32 %k.0, 1, !taffo.info !33, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond141

for.end161:                                       ; preds = %for.cond141
  %idxprom162 = sext i32 %i.4 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  %idxprom168 = sext i32 %i.4 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  store double %tmp19, double* %arrayidx169, align 8, !taffo.info !81, !taffo.initweight !30
  br label %for.inc170

for.inc170:                                       ; preds = %for.end161
  %inc171 = add nsw i32 %j.4, 1, !taffo.info !33, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond133
...
for.inc173:                                       ; preds = %for.end172
  %inc174 = add nsw i32 %i.4, 1, !taffo.info !28, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond124
...
for.end175:                                       ; preds = %for.cond124
  ...
  store double 1.000000e+00, double* %arrayidx177, align 8, !taffo.info !81, !taffo.initweight !30, !taffo.constinfo !82
...
for.body185:                                      ; preds = %for.cond182
  %idxprom186 = sext i32 %i.5 to i64, !taffo.info !28, !taffo.initweight !29
  ...
  %idxprom188 = sext i32 %j.5 to i64, !taffo.info !33, !taffo.initweight !29
  ...
  %call190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.9, i32 0, i32 0), double %tmp20), !taffo.info !24, !taffo.initweight !36, !taffo.constinfo !90
  br label %for.inc191

for.inc191:                                       ; preds = %for.body185
  %inc192 = add nsw i32 %j.5, 1, !taffo.info !33, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond182

for.end193:                                       ; preds = %for.cond182
  %call194 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0)), !taffo.constinfo !48
  br label %for.inc195

for.inc195:                                       ; preds = %for.end193
  %inc196 = add nsw i32 %i.5, 1, !taffo.info !28, !taffo.initweight !29, !taffo.constinfo !48
  br label %for.cond178
...
declare !taffo.initweight !91 !taffo.funinfo !92 dso_local double @sqrt(double) #1
...
!35 = !{double 0.000000e+00, double 8.750000e-01}
!36 = !{i32 4}
!37 = !{i1 false, !38}
!38 = !{i1 false, !39, i1 false, i2 0}
!39 = !{double 3.200000e+01, double 3.200000e+01}
!40 = !{i1 false, !41, i1 false, i2 -2}
!41 = !{double 0.000000e+00, double 2.887500e+01}
!42 = !{i1 false, !43, i1 false, i2 -2}
!43 = !{double 0.000000e+00, double 1.031250e+00}
!44 = !{i1 false, !45}
!45 = !{i1 false, !46, i1 false, i2 0}
!46 = !{double 2.800000e+01, double 2.800000e+01}
!47 = !{i1 false, !14, !10, i2 -1}
!48 = !{i1 false, i1 false}
!49 = !{i1 false, !9, !10, i2 -1}
!50 = !{!51, i1 false}
...
!55 = !{!56, !57, !10, i2 1}
!56 = !{!"fixp", i32 -32, i32 20}
!57 = !{double 0xC09BE6DB6DB6DB6E, double 0x409BE6DB6DB6DB6E}
!58 = !{i1 false, !20, !10, i2 -1}
!59 = !{!60, !61, !10, i2 -1}
!60 = !{!"fixp", i32 -64, i32 31}
!61 = !{double 0xC1E2A24774800000, double 0x41E2A24774800000}
!62 = !{!60, !63, !10, i2 -1}
!63 = !{double 0xC1E2A24974800000, double 0x41E2A24974800000}
!64 = !{!65, !66, !10, i2 1}
!65 = !{!"fixp", i32 -32, i32 23}
!66 = !{double 0xC062492492492492, double 0x4062492492492492}
!67 = !{!68, !69, !10, i2 -1}
!68 = !{!"fixp", i32 32, i32 25}
!69 = !{double 0.000000e+00, double 6.400000e+01}
!70 = !{i1 false, i1 false, i1 false, i2 1}
!71 = !{!16, !72, !10, i2 1}
!72 = !{double 0x40152A7FA9D2F8EA, double 0x40152A7FA9D2F8EA}
!73 = !{!45, i1 false}
!74 = !{!75, !20, !10, i2 -1}
!75 = !{!"fixp", i32 -32, i32 16}
!76 = !{!75, !77, !10, i2 -1}
!77 = !{double 0xC0D52A7FA9D2F8EA, double 0x40D52A7FA9D2F8EA}
!78 = !{!79, !80, !10, i2 -1}
!79 = !{!"fixp", i32 -32, i32 30}
!80 = !{double 0xBF3E3CB66051F5E0, double 0x3F3E3CB66051F5E0}
!81 = !{i1 false, !17, !10, i2 -1}
!82 = !{!83, i1 false}
