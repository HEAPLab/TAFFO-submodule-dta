...
for.body101:                                      ; preds = %for.cond98
  ...
  %div117 = fdiv double %tmp15, %mul112, !taffo.info !55, !taffo.initweight !33
...
for.body127:                                      ; preds = %for.cond124
  ...
  store double 1.000000e+00, double* %arrayidx131, align 8, !taffo.info !56, !taffo.initweight !30, !taffo.constinfo !57
...
for.body136:                                      ; preds = %for.cond133
  ...
  store double 0.000000e+00, double* %arrayidx140, align 8, !taffo.info !56, !taffo.initweight !30, !taffo.constinfo !43
...
for.body144:                                      ; preds = %for.cond141
  ...
  store double %add158, double* %arrayidx157, align 8, !taffo.info !56, !taffo.initweight !30
  br label %for.inc159
...
for.end161:                                       ; preds = %for.cond141
  ...
  store double %tmp19, double* %arrayidx169, align 8, !taffo.info !56, !taffo.initweight !30
  br label %for.inc170
...
for.end175:                                       ; preds = %for.cond124
  ...
  store double 1.000000e+00, double* %arrayidx177, align 8, !taffo.info !56, !taffo.initweight !30, !taffo.constinfo !57
...
for.body185:                                      ; preds = %for.cond182
  ...
  %call190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.9, i32 0, i32 0), double %tmp20), !taffo.info !23, !taffo.initweight !33, !taffo.constinfo !60
  br label %for.inc191
...
declare !taffo.initweight !61 !taffo.funinfo !62 dso_local double @sqrt(double) #1

declare !taffo.initweight !61 !taffo.funinfo !62 dso_local i32 @printf(i8*, ...) #2
...
!11 = !{i32 0}
!12 = !{!8, !13, !10, i2 -1}
!13 = !{double -1.000000e+01, double 1.000000e+01}
!14 = !{!8, !15, !10, i2 -1}
