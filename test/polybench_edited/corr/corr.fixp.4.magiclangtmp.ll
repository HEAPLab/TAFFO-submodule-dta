...
@data = common dso_local global [28 x [32 x double]] zeroinitializer, align 16, !taffo.info !6, !taffo.initweight !10
@mean = common dso_local global [32 x double] zeroinitializer, align 16, !taffo.info !11, !taffo.initweight !10
@stddev = common dso_local global [32 x double] zeroinitializer, align 16, !taffo.info !14, !taffo.initweight !10
@corr = common dso_local global [32 x [32 x double]] zeroinitializer, align 16, !taffo.info !18, !taffo.initweight !10
...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  %cmp = icmp slt i32 %i.0, 28, !taffo.info !35, !taffo.initweight !36
...
for.cond5:                                        ; preds = %for.inc, %for.body
  ...
  %cmp6 = icmp slt i32 %j.0, 32, !taffo.info !40, !taffo.initweight !36
...
for.body7:                                        ; preds = %for.cond5
  ...
  %div = fdiv double %conv, 3.200000e+01, !taffo.info !43, !taffo.initweight !46, !taffo.constinfo !47
  ...
  %div9 = fdiv double %add, 2.800000e+01, !taffo.info !52, !taffo.initweight !46, !taffo.constinfo !55
  %idxprom = sext i32 %i.0 to i64, !taffo.info !35, !taffo.initweight !36
  %arrayidx = getelementptr inbounds [28 x [32 x double]], [28 x [32 x double]]* @data, i64 0, i64 %idxprom, !taffo.info !6, !taffo.initweight !58
  %idxprom10 = sext i32 %j.0 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx11 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx, i64 0, i64 %idxprom10, !taffo.info !6, !taffo.initweight !36
  store double %div9, double* %arrayidx11, align 8, !taffo.info !59, !taffo.initweight !37
  br label %for.inc
...
for.cond16:                                       ; preds = %for.inc39, %for.end14
  ...
  %cmp17 = icmp slt i32 %j.1, 32, !taffo.info !40, !taffo.initweight !36
...
for.body19:                                       ; preds = %for.cond16
  ...
  %arrayidx21 = getelementptr inbounds [32 x double], [32 x double]* @mean, i64 0, i64 %idxprom20, !taffo.info !11, !taffo.initweight !58
  store double 0.000000e+00, double* %arrayidx21, align 8, !taffo.info !60, !taffo.initweight !36, !taffo.constinfo !61
  br label %for.cond22

for.cond22:                                       ; preds = %for.inc33, %for.body19
  %i.1 = phi i32 [ 0, %for.body19 ], [ %inc34, %for.inc33 ], !taffo.info !33
  %cmp23 = icmp slt i32 %i.1, 28, !taffo.info !35, !taffo.initweight !36
...
for.body25:                                       ; preds = %for.cond22
  ...
  %arrayidx27 = getelementptr inbounds [28 x [32 x double]], [28 x [32 x double]]* @data, i64 0, i64 %idxprom26, !taffo.info !6, !taffo.initweight !58
  %idxprom28 = sext i32 %j.1 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx29 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx27, i64 0, i64 %idxprom28, !taffo.info !6, !taffo.initweight !36
  ...
  %arrayidx31 = getelementptr inbounds [32 x double], [32 x double]* @mean, i64 0, i64 %idxprom30, !taffo.info !11, !taffo.initweight !58
  %tmp1 = load double, double* %arrayidx31, align 8, !taffo.info !11, !taffo.initweight !36
  %add32 = fadd double %tmp1, %tmp, !taffo.info !62, !taffo.initweight !37
  store double %add32, double* %arrayidx31, align 8, !taffo.info !60, !taffo.initweight !36
  br label %for.inc33
...
for.end35:                                        ; preds = %for.cond22
  ...
  %arrayidx37 = getelementptr inbounds [32 x double], [32 x double]* @mean, i64 0, i64 %idxprom36, !taffo.info !11, !taffo.initweight !58
  %tmp2 = load double, double* %arrayidx37, align 8, !taffo.info !11, !taffo.initweight !36
  %div38 = fdiv double %tmp2, 2.800000e+01, !taffo.info !64, !taffo.initweight !36, !taffo.constinfo !55
  store double %div38, double* %arrayidx37, align 8, !taffo.info !60, !taffo.initweight !36
  br label %for.inc39
...
for.cond42:                                       ; preds = %for.inc87, %for.end41
  ...
  %cmp43 = icmp slt i32 %j.2, 32, !taffo.info !40, !taffo.initweight !36
...
for.body45:                                       ; preds = %for.cond42
  ...
  %arrayidx47 = getelementptr inbounds [32 x double], [32 x double]* @stddev, i64 0, i64 %idxprom46, !taffo.info !14, !taffo.initweight !58
  store double 0.000000e+00, double* %arrayidx47, align 8, !taffo.info !67, !taffo.initweight !36, !taffo.constinfo !61
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc69, %for.body45
  %i.2 = phi i32 [ 0, %for.body45 ], [ %inc70, %for.inc69 ], !taffo.info !33
  %cmp49 = icmp slt i32 %i.2, 28, !taffo.info !35, !taffo.initweight !36
...
for.body51:                                       ; preds = %for.cond48
  ...
  %arrayidx53 = getelementptr inbounds [28 x [32 x double]], [28 x [32 x double]]* @data, i64 0, i64 %idxprom52, !taffo.info !6, !taffo.initweight !58
  %idxprom54 = sext i32 %j.2 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx55 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx53, i64 0, i64 %idxprom54, !taffo.info !6, !taffo.initweight !36
  ...
  %arrayidx57 = getelementptr inbounds [32 x double], [32 x double]* @mean, i64 0, i64 %idxprom56, !taffo.info !11, !taffo.initweight !58
  %tmp4 = load double, double* %arrayidx57, align 8, !taffo.info !11, !taffo.initweight !36
  %sub = fsub double %tmp3, %tmp4, !taffo.info !62, !taffo.initweight !37
  %idxprom58 = sext i32 %i.2 to i64, !taffo.info !35, !taffo.initweight !36
  %arrayidx59 = getelementptr inbounds [28 x [32 x double]], [28 x [32 x double]]* @data, i64 0, i64 %idxprom58, !taffo.info !6, !taffo.initweight !58
  %idxprom60 = sext i32 %j.2 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx61 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx59, i64 0, i64 %idxprom60, !taffo.info !6, !taffo.initweight !36
  ...
  %arrayidx63 = getelementptr inbounds [32 x double], [32 x double]* @mean, i64 0, i64 %idxprom62, !taffo.info !11, !taffo.initweight !58
  %tmp6 = load double, double* %arrayidx63, align 8, !taffo.info !11, !taffo.initweight !36
  %sub64 = fsub double %tmp5, %tmp6, !taffo.info !62, !taffo.initweight !37
  %mul65 = fmul double %sub, %sub64, !taffo.info !68, !taffo.initweight !46
  %idxprom66 = sext i32 %j.2 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx67 = getelementptr inbounds [32 x double], [32 x double]* @stddev, i64 0, i64 %idxprom66, !taffo.info !14, !taffo.initweight !58
  %tmp7 = load double, double* %arrayidx67, align 8, !taffo.info !14, !taffo.initweight !36
  %add68 = fadd double %tmp7, %mul65, !taffo.info !71, !taffo.initweight !37
  store double %add68, double* %arrayidx67, align 8, !taffo.info !67, !taffo.initweight !36
  br label %for.inc69
...
for.end71:                                        ; preds = %for.cond48
  ...
  %arrayidx73 = getelementptr inbounds [32 x double], [32 x double]* @stddev, i64 0, i64 %idxprom72, !taffo.info !14, !taffo.initweight !58
  %tmp8 = load double, double* %arrayidx73, align 8, !taffo.info !14, !taffo.initweight !36
  %div74 = fdiv double %tmp8, 2.800000e+01, !taffo.info !73, !taffo.initweight !36, !taffo.constinfo !55
  store double %div74, double* %arrayidx73, align 8, !taffo.info !67, !taffo.initweight !36
  %idxprom75 = sext i32 %j.2 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx76 = getelementptr inbounds [32 x double], [32 x double]* @stddev, i64 0, i64 %idxprom75, !taffo.info !14, !taffo.initweight !58
  %tmp9 = load double, double* %arrayidx76, align 8, !taffo.info !14, !taffo.initweight !36
  %call = call double @sqrt(double %tmp9) #3, !taffo.info !76, !taffo.initweight !37, !taffo.constinfo !29
  %idxprom77 = sext i32 %j.2 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx78 = getelementptr inbounds [32 x double], [32 x double]* @stddev, i64 0, i64 %idxprom77, !taffo.info !14, !taffo.initweight !58
  store double %call, double* %arrayidx78, align 8, !taffo.info !67, !taffo.initweight !36
  %idxprom79 = sext i32 %j.2 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx80 = getelementptr inbounds [32 x double], [32 x double]* @stddev, i64 0, i64 %idxprom79, !taffo.info !14, !taffo.initweight !58
  %tmp10 = load double, double* %arrayidx80, align 8, !taffo.info !14, !taffo.initweight !36
  %cmp81 = fcmp ole double %tmp10, 1.000000e-01, !taffo.info !79, !taffo.initweight !36
  br i1 %cmp81, label %cond.true, label %cond.false, !taffo.info !80, !taffo.initweight !37
...
cond.false:                                       ; preds = %for.end71
  ...
  %arrayidx84 = getelementptr inbounds [32 x double], [32 x double]* @stddev, i64 0, i64 %idxprom83, !taffo.info !14, !taffo.initweight !58
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %arrayidx86 = getelementptr inbounds [32 x double], [32 x double]* @stddev, i64 0, i64 %idxprom85, !taffo.info !14, !taffo.initweight !58
  store double %cond, double* %arrayidx86, align 8, !taffo.info !67, !taffo.initweight !36
  br label %for.inc87
...
for.cond90:                                       ; preds = %for.inc117, %for.end89
  ...
  %cmp91 = icmp slt i32 %i.3, 28, !taffo.info !35, !taffo.initweight !36
...
for.cond94:                                       ; preds = %for.inc114, %for.body93
  ...
  %cmp95 = icmp slt i32 %j.3, 32, !taffo.info !40, !taffo.initweight !36
...
for.body97:                                       ; preds = %for.cond94
  ...
  %arrayidx99 = getelementptr inbounds [32 x double], [32 x double]* @mean, i64 0, i64 %idxprom98, !taffo.info !11, !taffo.initweight !58
  ...
  %arrayidx101 = getelementptr inbounds [28 x [32 x double]], [28 x [32 x double]]* @data, i64 0, i64 %idxprom100, !taffo.info !6, !taffo.initweight !58
  %idxprom102 = sext i32 %j.3 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx103 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx101, i64 0, i64 %idxprom102, !taffo.info !6, !taffo.initweight !36
  %tmp13 = load double, double* %arrayidx103, align 8, !taffo.info !6, !taffo.initweight !37
  %sub104 = fsub double %tmp13, %tmp12, !taffo.info !62, !taffo.initweight !37
  store double %sub104, double* %arrayidx103, align 8, !taffo.info !59, !taffo.initweight !37
  %call105 = call double @sqrt(double 2.800000e+01) #3, !taffo.info !81, !taffo.initweight !36, !taffo.constinfo !83
  %idxprom106 = sext i32 %j.3 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx107 = getelementptr inbounds [32 x double], [32 x double]* @stddev, i64 0, i64 %idxprom106, !taffo.info !14, !taffo.initweight !58
  %tmp14 = load double, double* %arrayidx107, align 8, !taffo.info !84, !taffo.initweight !36
  %mul108 = fmul double %call105, %tmp14, !taffo.info !86, !taffo.initweight !37
  %idxprom109 = sext i32 %i.3 to i64, !taffo.info !35, !taffo.initweight !36
  %arrayidx110 = getelementptr inbounds [28 x [32 x double]], [28 x [32 x double]]* @data, i64 0, i64 %idxprom109, !taffo.info !6, !taffo.initweight !58
  %idxprom111 = sext i32 %j.3 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx112 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx110, i64 0, i64 %idxprom111, !taffo.info !6, !taffo.initweight !36
  %tmp15 = load double, double* %arrayidx112, align 8, !taffo.info !6, !taffo.initweight !37
  %div113 = fdiv double %tmp15, %mul108, !taffo.info !88, !taffo.initweight !46
  store double %div113, double* %arrayidx112, align 8, !taffo.info !59, !taffo.initweight !37
  br label %for.inc114
...
for.cond120:                                      ; preds = %for.inc169, %for.end119
  ...
  %cmp121 = icmp slt i32 %i.4, 31, !taffo.info !35, !taffo.initweight !36
...
for.body123:                                      ; preds = %for.cond120
  ...
  %arrayidx125 = getelementptr inbounds [32 x [32 x double]], [32 x [32 x double]]* @corr, i64 0, i64 %idxprom124, !taffo.info !18, !taffo.initweight !58
  %idxprom126 = sext i32 %i.4 to i64, !taffo.info !35, !taffo.initweight !36
  %arrayidx127 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx125, i64 0, i64 %idxprom126, !taffo.info !18, !taffo.initweight !36
  store double 1.000000e+00, double* %arrayidx127, align 8, !taffo.info !91, !taffo.initweight !37, !taffo.constinfo !92
...
for.cond129:                                      ; preds = %for.inc166, %for.body123
  ...
  %cmp130 = icmp slt i32 %j.4, 32, !taffo.info !40, !taffo.initweight !36
...
for.body132:                                      ; preds = %for.cond129
  ...
  %arrayidx134 = getelementptr inbounds [32 x [32 x double]], [32 x [32 x double]]* @corr, i64 0, i64 %idxprom133, !taffo.info !18, !taffo.initweight !58
  %idxprom135 = sext i32 %j.4 to i64, !taffo.info !35, !taffo.initweight !36
  %arrayidx136 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx134, i64 0, i64 %idxprom135, !taffo.info !18, !taffo.initweight !36
  store double 0.000000e+00, double* %arrayidx136, align 8, !taffo.info !91, !taffo.initweight !37, !taffo.constinfo !61
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc155, %for.body132
  %k.0 = phi i32 [ 0, %for.body132 ], [ %inc156, %for.inc155 ], !taffo.info !38
  %cmp138 = icmp slt i32 %k.0, 28, !taffo.info !40, !taffo.initweight !36
...
for.body140:                                      ; preds = %for.cond137
  ...
  %arrayidx142 = getelementptr inbounds [28 x [32 x double]], [28 x [32 x double]]* @data, i64 0, i64 %idxprom141, !taffo.info !6, !taffo.initweight !58
  %idxprom143 = sext i32 %i.4 to i64, !taffo.info !35, !taffo.initweight !36
  %arrayidx144 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx142, i64 0, i64 %idxprom143, !taffo.info !6, !taffo.initweight !36
  ...
  %arrayidx146 = getelementptr inbounds [28 x [32 x double]], [28 x [32 x double]]* @data, i64 0, i64 %idxprom145, !taffo.info !6, !taffo.initweight !58
  %idxprom147 = sext i32 %j.4 to i64, !taffo.info !35, !taffo.initweight !36
  %arrayidx148 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx146, i64 0, i64 %idxprom147, !taffo.info !6, !taffo.initweight !36
  %tmp17 = load double, double* %arrayidx148, align 8, !taffo.info !6, !taffo.initweight !37
  %mul149 = fmul double %tmp16, %tmp17, !taffo.info !95, !taffo.initweight !46
  %idxprom150 = sext i32 %i.4 to i64, !taffo.info !35, !taffo.initweight !36
  %arrayidx151 = getelementptr inbounds [32 x [32 x double]], [32 x [32 x double]]* @corr, i64 0, i64 %idxprom150, !taffo.info !18, !taffo.initweight !58
  %idxprom152 = sext i32 %j.4 to i64, !taffo.info !35, !taffo.initweight !36
  %arrayidx153 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx151, i64 0, i64 %idxprom152, !taffo.info !18, !taffo.initweight !36
  %tmp18 = load double, double* %arrayidx153, align 8, !taffo.info !18, !taffo.initweight !37
  %add154 = fadd double %tmp18, %mul149, !taffo.info !98, !taffo.initweight !46
  store double %add154, double* %arrayidx153, align 8, !taffo.info !91, !taffo.initweight !37
  br label %for.inc155
...
for.end157:                                       ; preds = %for.cond137
  ...
  %arrayidx159 = getelementptr inbounds [32 x [32 x double]], [32 x [32 x double]]* @corr, i64 0, i64 %idxprom158, !taffo.info !18, !taffo.initweight !58
  %idxprom160 = sext i32 %j.4 to i64, !taffo.info !35, !taffo.initweight !36
  %arrayidx161 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx159, i64 0, i64 %idxprom160, !taffo.info !18, !taffo.initweight !36
  ...
  %arrayidx163 = getelementptr inbounds [32 x [32 x double]], [32 x [32 x double]]* @corr, i64 0, i64 %idxprom162, !taffo.info !18, !taffo.initweight !58
  %idxprom164 = sext i32 %i.4 to i64, !taffo.info !35, !taffo.initweight !36
  %arrayidx165 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx163, i64 0, i64 %idxprom164, !taffo.info !18, !taffo.initweight !36
  store double %tmp19, double* %arrayidx165, align 8, !taffo.info !91, !taffo.initweight !37
  br label %for.inc166
...
for.end171:                                       ; preds = %for.cond120
  store double 1.000000e+00, double* getelementptr inbounds ([32 x [32 x double]], [32 x [32 x double]]* @corr, i64 0, i64 31, i64 31), align 8, !taffo.info !91, !taffo.initweight !36, !taffo.constinfo !92
...
for.cond172:                                      ; preds = %for.inc189, %for.end171
  ...
  %cmp173 = icmp slt i32 %i.5, 32, !taffo.info !35, !taffo.initweight !36
...
for.cond176:                                      ; preds = %for.inc185, %for.body175
  ...
  %cmp177 = icmp slt i32 %j.5, 32, !taffo.info !40, !taffo.initweight !36
...
for.body179:                                      ; preds = %for.cond176
  ...
  %arrayidx181 = getelementptr inbounds [32 x [32 x double]], [32 x [32 x double]]* @corr, i64 0, i64 %idxprom180, !taffo.info !18, !taffo.initweight !58
  %idxprom182 = sext i32 %j.5 to i64, !taffo.info !40, !taffo.initweight !36
  %arrayidx183 = getelementptr inbounds [32 x double], [32 x double]* %arrayidx181, i64 0, i64 %idxprom182, !taffo.info !18, !taffo.initweight !36
  %tmp20 = load double, double* %arrayidx183, align 8, !taffo.info !18, !taffo.initweight !37
  %call184 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.6, i32 0, i32 0), double %tmp20), !taffo.info !100, !taffo.initweight !46, !taffo.constinfo !101
  br label %for.inc185
...
; Function Attrs: nounwind
declare !taffo.initweight !102 !taffo.funinfo !103 dso_local double @sqrt(double) #1

declare !taffo.initweight !102 !taffo.funinfo !103 dso_local i32 @printf(i8*, ...) #2
...
!53 = !{!"fixp", i32 32, i32 30}
!54 = !{double 0.000000e+00, double 1.031250e+00}
!55 = !{i1 false, !56}
!56 = !{i1 false, !57, i1 false, i2 0}
!57 = !{double 2.800000e+01, double 2.800000e+01}
!58 = !{i32 1}
...
!66 = !{double 0xC09BE6DB6DB6DB6E, double 0x409BE6DB6DB6DB6E}
...
!75 = !{double 0xC062492492492492, double 0x4062492492492492}
!76 = !{!77, !78, !17, i2 -1}
...
!81 = !{!19, !82, !9, i2 1}
!82 = !{double 0x40152A7FA9D2F8EA, double 0x40152A7FA9D2F8EA}
!83 = !{!56, i1 false}
!84 = !{!85, !16, !17, i2 -1}
!85 = !{!"fixp", i32 -32, i32 16}
!86 = !{!85, !87, !17, i2 -1}
!87 = !{double 0xC0D52A7FA9D2F8EA, double 0x40D52A7FA9D2F8EA}
!88 = !{!89, !90, !9, i2 -1}
!89 = !{!"fixp", i32 -32, i32 30}
!90 = !{double 0xBF3E3CB66051F5E0, double 0x3F3E3CB66051F5E0}
