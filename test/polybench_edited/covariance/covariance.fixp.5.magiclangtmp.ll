...
entry:
  ...
  %cov.s31_33fixp = alloca [100 x [80 x i64]], align 16, !taffo.info !12
...
for.body12:                                       ; preds = %for.cond9
  ...
  %conv14 = sitofp i32 %j.0 to double, !taffo.info !30, !taffo.initweight !22
  %mul = fmul double %conv13, %conv14, !taffo.info !30, !taffo.initweight !25
  %div = fdiv double %mul, 8.000000e+01, !taffo.info !32, !taffo.initweight !34, !taffo.constinfo !35
  %0 = fmul double 1.310720e+05, %div, !taffo.info !32, !taffo.constinfo !35
  ...
  %idxprom15 = sext i32 %j.0 to i64, !taffo.info !30, !taffo.initweight !22
  %arrayidx16.s15_17fixp = getelementptr inbounds [80 x i32], [80 x i32]* %arrayidx.s15_17fixp, i64 0, i64 %idxprom15, !taffo.info !8
  store i32 %1, i32* %arrayidx16.s15_17fixp, align 8, !taffo.info !38
  br label %for.inc

for.inc:                                          ; preds = %for.body12
  %inc = add nsw i32 %j.0, 1, !taffo.info !39, !taffo.initweight !22, !taffo.constinfo !41
  br label %for.cond9
...
for.inc17:                                        ; preds = %for.end
  %inc18 = add nsw i32 %i.0, 1, !taffo.info !42, !taffo.initweight !22, !taffo.constinfo !41
  br label %for.cond
...
for.body23:                                       ; preds = %for.cond20
  ...
  store i32 0, i32* %arrayidx25.s14_18fixp, align 8, !taffo.info !44, !taffo.constinfo !45
  br label %for.cond26
...
for.body29:                                       ; preds = %for.cond26
  %idxprom30 = sext i32 %i.1 to i64, !taffo.info !30, !taffo.initweight !22
  ...
  %tmp1.s14_18fixp = load i32, i32* %arrayidx35.s14_18fixp, align 8, !taffo.info !48
  %2 = ashr i32 %tmp1.s14_18fixp, 1, !taffo.info !48
  %add.s15_17fixp = add i32 %2, %tmp.s15_17fixp, !taffo.info !49
  %3 = shl i32 %add.s15_17fixp, 1, !taffo.info !49
  store i32 %3, i32* %arrayidx35.s14_18fixp, align 8, !taffo.info !44
  br label %for.inc36

for.inc36:                                        ; preds = %for.body29
  %inc37 = add nsw i32 %i.1, 1, !taffo.info !39, !taffo.initweight !22, !taffo.constinfo !41
  br label %for.cond26
...
for.end38:                                        ; preds = %for.cond26
  ...
  %tmp2.s14_18fixp = load i32, i32* %arrayidx40.s14_18fixp, align 8, !taffo.info !48
  %4 = sext i32 %tmp2.s14_18fixp to i64, !taffo.info !48
  %5 = sdiv i64 %4, 100, !taffo.info !51
  %6 = ashr i64 %5, 1, !taffo.info !51
  %div41.s15_17fixp = trunc i64 %6 to i32, !taffo.info !8
  %7 = shl i32 %div41.s15_17fixp, 1, !taffo.info !8
  store i32 %7, i32* %arrayidx40.s14_18fixp, align 8, !taffo.info !44
  br label %for.inc42

for.inc42:                                        ; preds = %for.end38
  %inc43 = add nsw i32 %j.1, 1, !taffo.info !42, !taffo.initweight !22, !taffo.constinfo !41
  br label %for.cond20
...
for.body52:                                       ; preds = %for.cond49
  %idxprom53 = sext i32 %j.2 to i64, !taffo.info !30, !taffo.initweight !22
  %arrayidx54.s14_18fixp = getelementptr inbounds [80 x i32], [80 x i32]* %mean.s14_18fixp, i64 0, i64 %idxprom53, !taffo.info !15
  %tmp3.s14_18fixp = load i32, i32* %arrayidx54.s14_18fixp, align 8, !taffo.info !48
  ...
  %idxprom57 = sext i32 %j.2 to i64, !taffo.info !30, !taffo.initweight !22
  ...
  %8 = ashr i32 %tmp3.s14_18fixp, 1, !taffo.info !48
  %sub.s15_17fixp = sub i32 %tmp4.s15_17fixp, %8, !taffo.info !49
  store i32 %sub.s15_17fixp, i32* %arrayidx58.s15_17fixp, align 8, !taffo.info !38
  br label %for.inc59

for.inc59:                                        ; preds = %for.body52
  %inc60 = add nsw i32 %j.2, 1, !taffo.info !39, !taffo.initweight !22, !taffo.constinfo !41
  br label %for.cond49
...
for.inc62:                                        ; preds = %for.end61
  %inc63 = add nsw i32 %i.2, 1, !taffo.info !42, !taffo.initweight !22, !taffo.constinfo !41
  br label %for.cond45
...
for.body72:                                       ; preds = %for.cond69
  ...
  %arrayidx74.s31_33fixp = getelementptr inbounds [100 x [80 x i64]], [100 x [80 x i64]]* %cov.s31_33fixp, i64 0, i64 %idxprom73, !taffo.info !12
  %idxprom75 = sext i32 %j.3 to i64, !taffo.info !18, !taffo.initweight !22
  %arrayidx76.s31_33fixp = getelementptr inbounds [80 x i64], [80 x i64]* %arrayidx74.s31_33fixp, i64 0, i64 %idxprom75, !taffo.info !12
  store i64 0, i64* %arrayidx76.s31_33fixp, align 8, !taffo.info !53, !taffo.constinfo !45
  br label %for.cond77
...
for.body80:                                       ; preds = %for.cond77
  %idxprom81 = sext i32 %k.0 to i64, !taffo.info !30, !taffo.initweight !22
  ...
  %idxprom85 = sext i32 %k.0 to i64, !taffo.info !30, !taffo.initweight !22
  ...
  %idxprom87 = sext i32 %j.3 to i64, !taffo.info !18, !taffo.initweight !22
  ...
  %11 = mul i64 %9, %10, !taffo.info !55
  %12 = ashr i64 %11, 30, !taffo.info !55
  %mul89.s28_4fixp = trunc i64 %12 to i32, !taffo.info !58
  %idxprom90 = sext i32 %i.3 to i64, !taffo.info !28, !taffo.initweight !22
  %arrayidx91.s31_33fixp = getelementptr inbounds [100 x [80 x i64]], [100 x [80 x i64]]* %cov.s31_33fixp, i64 0, i64 %idxprom90, !taffo.info !12
  %idxprom92 = sext i32 %j.3 to i64, !taffo.info !18, !taffo.initweight !22
  %arrayidx93.s31_33fixp = getelementptr inbounds [80 x i64], [80 x i64]* %arrayidx91.s31_33fixp, i64 0, i64 %idxprom92, !taffo.info !12
  %tmp7.s31_33fixp = load i64, i64* %arrayidx93.s31_33fixp, align 8, !taffo.info !60
  %13 = sext i32 %mul89.s28_4fixp to i64, !taffo.info !58
  %14 = shl i64 %13, 29, !taffo.info !58
  %add94.s31_33fixp = add i64 %tmp7.s31_33fixp, %14, !taffo.info !12
  store i64 %add94.s31_33fixp, i64* %arrayidx93.s31_33fixp, align 8, !taffo.info !53
  br label %for.inc95

for.inc95:                                        ; preds = %for.body80
  %inc96 = add nsw i32 %k.0, 1, !taffo.info !39, !taffo.initweight !22, !taffo.constinfo !41
  br label %for.cond77

for.end97:                                        ; preds = %for.cond77
  %idxprom98 = sext i32 %i.3 to i64, !taffo.info !28, !taffo.initweight !22
  %arrayidx99.s31_33fixp = getelementptr inbounds [100 x [80 x i64]], [100 x [80 x i64]]* %cov.s31_33fixp, i64 0, i64 %idxprom98, !taffo.info !12
  %idxprom100 = sext i32 %j.3 to i64, !taffo.info !18, !taffo.initweight !22
  %arrayidx101.s31_33fixp = getelementptr inbounds [80 x i64], [80 x i64]* %arrayidx99.s31_33fixp, i64 0, i64 %idxprom100, !taffo.info !12
  %tmp8.s31_33fixp = load i64, i64* %arrayidx101.s31_33fixp, align 8, !taffo.info !12
  %15 = sext i64 %tmp8.s31_33fixp to i96, !taffo.info !12
  %16 = sdiv i96 %15, 99, !taffo.info !62, !taffo.constinfo !65
  %17 = ashr i96 %16, 26, !taffo.info !62, !taffo.constinfo !65
  %div102.s25_7fixp = trunc i96 %17 to i32, !taffo.info !69
  %18 = sext i32 %div102.s25_7fixp to i64, !taffo.info !69
  %19 = shl i64 %18, 26, !taffo.info !69
  store i64 %19, i64* %arrayidx101.s31_33fixp, align 8, !taffo.info !53
  %idxprom103 = sext i32 %i.3 to i64, !taffo.info !28, !taffo.initweight !22
  %arrayidx104.s31_33fixp = getelementptr inbounds [100 x [80 x i64]], [100 x [80 x i64]]* %cov.s31_33fixp, i64 0, i64 %idxprom103, !taffo.info !12
  %idxprom105 = sext i32 %j.3 to i64, !taffo.info !18, !taffo.initweight !22
  %arrayidx106.s31_33fixp = getelementptr inbounds [80 x i64], [80 x i64]* %arrayidx104.s31_33fixp, i64 0, i64 %idxprom105, !taffo.info !12
  %tmp9.s31_33fixp = load i64, i64* %arrayidx106.s31_33fixp, align 8, !taffo.info !12
  %idxprom107 = sext i32 %j.3 to i64, !taffo.info !18, !taffo.initweight !22
  %arrayidx108.s31_33fixp = getelementptr inbounds [100 x [80 x i64]], [100 x [80 x i64]]* %cov.s31_33fixp, i64 0, i64 %idxprom107, !taffo.info !12
  %idxprom109 = sext i32 %i.3 to i64, !taffo.info !28, !taffo.initweight !22
  %arrayidx110.s31_33fixp = getelementptr inbounds [80 x i64], [80 x i64]* %arrayidx108.s31_33fixp, i64 0, i64 %idxprom109, !taffo.info !12
  store i64 %tmp9.s31_33fixp, i64* %arrayidx110.s31_33fixp, align 8, !taffo.info !53
  br label %for.inc111

for.inc111:                                       ; preds = %for.end97
  %inc112 = add nsw i32 %j.3, 1, !taffo.info !71, !taffo.initweight !22, !taffo.constinfo !41
  br label %for.cond69
...
for.inc114:                                       ; preds = %for.end113
  %inc115 = add nsw i32 %i.3, 1, !taffo.info !42, !taffo.initweight !22, !taffo.constinfo !41
  br label %for.cond65
...
for.body124:                                      ; preds = %for.cond121
  %mul125 = mul nsw i32 %i.4, 80, !taffo.info !73, !taffo.initweight !22, !taffo.constinfo !41
  %add126 = add nsw i32 %mul125, %j.4, !taffo.info !75, !taffo.initweight !22
  %rem = srem i32 %add126, 20, !taffo.info !77, !taffo.initweight !25, !taffo.constinfo !41
  %cmp127 = icmp eq i32 %rem, 0, !taffo.info !28, !taffo.initweight !34
  br i1 %cmp127, label %if.then, label %if.end, !taffo.info !23, !taffo.initweight !79
...
if.end:                                           ; preds = %if.then, %for.body124
  ...
  %arrayidx130.s31_33fixp = getelementptr inbounds [100 x [80 x i64]], [100 x [80 x i64]]* %cov.s31_33fixp, i64 0, i64 %idxprom129, !taffo.info !12
  %idxprom131 = sext i32 %j.4 to i64, !taffo.info !30, !taffo.initweight !22
  %arrayidx132.s31_33fixp = getelementptr inbounds [80 x i64], [80 x i64]* %arrayidx130.s31_33fixp, i64 0, i64 %idxprom131, !taffo.info !12
  %tmp12.s31_33fixp = load i64, i64* %arrayidx132.s31_33fixp, align 8, !taffo.info !12
  %20 = sitofp i64 %tmp12.s31_33fixp to double, !taffo.info !12
  %21 = fdiv double %20, 0x4200000000000000, !taffo.info !12
  %call133.flt = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %tmp11, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.6, i32 0, i32 0), double %21), !taffo.info !81, !taffo.initweight !34, !taffo.constinfo !82
  br label %for.inc134

for.inc134:                                       ; preds = %if.end
  %inc135 = add nsw i32 %j.4, 1, !taffo.info !39, !taffo.initweight !22, !taffo.constinfo !41
  br label %for.cond121
...
for.inc137:                                       ; preds = %for.end136
  %inc138 = add nsw i32 %i.4, 1, !taffo.info !42, !taffo.initweight !22, !taffo.constinfo !41
  br label %for.cond117
...
!12 = !{!13, !14, !11, i2 1}
!13 = !{!"fixp", i32 -64, i32 33}
!14 = !{double -9.000100e+08, double 9.001000e+08}
!15 = !{!16, !17, !11, i2 -1}
...
!27 = !{double 0.000000e+00, double 4.000000e+00}
!28 = !{i1 false, !29, i1 false, i2 0}
!29 = !{double 0.000000e+00, double 1.000000e+00}
!30 = !{i1 false, !31, i1 false, i2 0}
!31 = !{double 0.000000e+00, double 3.000000e+00}
!32 = !{i1 false, !33, i1 false, i2 0}
!33 = !{double 0.000000e+00, double 3.750000e-02}
!34 = !{i32 4}
!35 = !{i1 false, !36}
!36 = !{i1 false, !37, i1 false, i2 0}
!37 = !{double 8.000000e+01, double 8.000000e+01}
!38 = !{i1 false, !10, !11, i2 -1}
!39 = !{i1 false, !40, i1 false, i2 0}
!40 = !{double 1.000000e+00, double 4.000000e+00}
!41 = !{i1 false, i1 false}
!42 = !{i1 false, !43, i1 false, i2 0}
!43 = !{double 1.000000e+00, double 2.000000e+00}
!44 = !{i1 false, !17, !11, i2 -1}
!45 = !{!46, i1 false}
!46 = !{i1 false, !47, i1 false, i2 0}
!47 = !{double 0.000000e+00, double 0.000000e+00}
!48 = !{!9, !17, !11, i2 -1}
!49 = !{!9, !50, !11, i2 -1}
!50 = !{double -1.500000e+04, double 1.500000e+04}
!51 = !{!52, !10, !11, i2 -1}
!52 = !{!"fixp", i32 -64, i32 18}
!53 = !{i1 false, !54, !11, i2 1}
!54 = !{double -1.000000e+04, double 1.000000e+05}
!55 = !{!56, !57, !11, i2 -1}
!56 = !{!"fixp", i32 -64, i32 34}
!57 = !{double -1.000000e+08, double 1.000000e+08}
!58 = !{!59, !57, !11, i2 -1}
!59 = !{!"fixp", i32 -32, i32 4}
!60 = !{!13, !61, !11, i2 1}
!61 = !{double -8.000100e+08, double 8.001000e+08}
!62 = !{!63, !64, !11, i2 1}
!63 = !{!"fixp", i32 -96, i32 33}
!64 = !{double 0xC16156F8433B7989, double 0x41615769E62433B8}
!65 = !{i1 false, !66}
!66 = !{!67, !68, i1 false, i2 0}
!67 = !{!"fixp", i32 32, i32 0}
