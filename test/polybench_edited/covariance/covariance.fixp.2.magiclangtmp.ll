...
@cov = common dso_local global [260 x [240 x double]] zeroinitializer, align 16, !taffo.initweight !0, !taffo.info !1
...
declare !taffo.initweight !8 !taffo.funinfo !9 dso_local i32 @clock_gettime(i32, %struct.timespec*) #1
...
for.cond:                                         ; preds = %for.inc14, %entry
  ...
  %cmp = icmp slt i32 %1, 260, !taffo.initweight !15, !taffo.info !12
...
for.cond6:                                        ; preds = %for.inc, %for.body
  ...
  %cmp7 = icmp slt i32 %2, 240, !taffo.initweight !15, !taffo.info !12
...
for.body9:                                        ; preds = %for.cond6
  ...
  %div = fdiv double %mul, 2.400000e+02, !taffo.initweight !17, !taffo.info !12
  %5 = load i32, i32* %i, align 4, !taffo.initweight !14, !taffo.info !12
  %idxprom = sext i32 %5 to i64, !taffo.initweight !15, !taffo.info !12
  %arrayidx = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom, !taffo.initweight !14, !taffo.info !1
  %6 = load i32, i32* %j, align 4, !taffo.initweight !14, !taffo.info !12
  %idxprom12 = sext i32 %6 to i64, !taffo.initweight !15, !taffo.info !12
  %arrayidx13 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx, i64 0, i64 %idxprom12, !taffo.initweight !15, !taffo.info !1
...
for.cond17:                                       ; preds = %for.inc39, %for.end16
  ...
  %cmp18 = icmp slt i32 %9, 240, !taffo.initweight !15, !taffo.info !12
...
for.body20:                                       ; preds = %for.cond17
  ...
  %arrayidx22 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom21, !taffo.initweight !14, !taffo.info !4
...
for.cond23:                                       ; preds = %for.inc33, %for.body20
  ...
  %cmp24 = icmp slt i32 %11, 260, !taffo.initweight !15, !taffo.info !12
...
for.body26:                                       ; preds = %for.cond23
  ...
  %arrayidx28 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom27, !taffo.initweight !14, !taffo.info !1
  ...
  %arrayidx30 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx28, i64 0, i64 %idxprom29, !taffo.initweight !15, !taffo.info !1
  ...
  %arrayidx32 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom31, !taffo.initweight !14, !taffo.info !4
...
for.end35:                                        ; preds = %for.cond23
  ...
  %arrayidx37 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom36, !taffo.initweight !14, !taffo.info !4
...
for.cond42:                                       ; preds = %for.inc59, %for.end41
  ...
  %cmp43 = icmp slt i32 %22, 260, !taffo.initweight !15, !taffo.info !12
...
for.cond46:                                       ; preds = %for.inc56, %for.body45
  ...
  %cmp47 = icmp slt i32 %23, 240, !taffo.initweight !15, !taffo.info !12
...
for.body49:                                       ; preds = %for.cond46
  ...
  %arrayidx51 = getelementptr inbounds [240 x double], [240 x double]* @mean, i64 0, i64 %idxprom50, !taffo.initweight !14, !taffo.info !4
  ...
  %arrayidx53 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom52, !taffo.initweight !14, !taffo.info !1
  ...
  %arrayidx55 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx53, i64 0, i64 %idxprom54, !taffo.initweight !15, !taffo.info !1
...
for.cond62:                                       ; preds = %for.inc111, %for.end61
  ...
  %cmp63 = icmp slt i32 %31, 240, !taffo.initweight !15, !taffo.info !12
...
for.cond66:                                       ; preds = %for.inc108, %for.body65
  ...
  %cmp67 = icmp slt i32 %33, 240, !taffo.initweight !15, !taffo.info !12
...
for.body69:                                       ; preds = %for.cond66
  ...
  %arrayidx71 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @cov, i64 0, i64 %idxprom70, !taffo.initweight !14, !taffo.info !1
  ...
  %arrayidx73 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx71, i64 0, i64 %idxprom72, !taffo.initweight !15, !taffo.info !1
...
for.cond74:                                       ; preds = %for.inc92, %for.body69
  ...
  %cmp75 = icmp slt i32 %36, 260, !taffo.initweight !15, !taffo.info !12
...
for.body77:                                       ; preds = %for.cond74
  ...
  %arrayidx79 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom78, !taffo.initweight !14, !taffo.info !1
  ...
  %arrayidx81 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx79, i64 0, i64 %idxprom80, !taffo.initweight !15, !taffo.info !1
  ...
  %arrayidx83 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @data, i64 0, i64 %idxprom82, !taffo.initweight !14, !taffo.info !1
  ...
  %arrayidx85 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx83, i64 0, i64 %idxprom84, !taffo.initweight !15, !taffo.info !1
  ...
  %arrayidx88 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @cov, i64 0, i64 %idxprom87, !taffo.initweight !14, !taffo.info !1
  ...
  %arrayidx90 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx88, i64 0, i64 %idxprom89, !taffo.initweight !15, !taffo.info !1
...
for.end94:                                        ; preds = %for.cond74
  ...
  %arrayidx96 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @cov, i64 0, i64 %idxprom95, !taffo.initweight !14, !taffo.info !1
  ...
  %arrayidx98 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx96, i64 0, i64 %idxprom97, !taffo.initweight !15, !taffo.info !1
  %49 = load double, double* %arrayidx98, align 8, !taffo.initweight !16, !taffo.info !1
  %div99 = fdiv double %49, 2.590000e+02, !taffo.initweight !17, !taffo.info !1
  ...
  %arrayidx101 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @cov, i64 0, i64 %idxprom100, !taffo.initweight !14, !taffo.info !1
  ...
  %arrayidx103 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx101, i64 0, i64 %idxprom102, !taffo.initweight !15, !taffo.info !1
  ...
  %arrayidx105 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @cov, i64 0, i64 %idxprom104, !taffo.initweight !14, !taffo.info !1
  ...
  %arrayidx107 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx105, i64 0, i64 %idxprom106, !taffo.initweight !15, !taffo.info !1
...
if.end:                                           ; preds = %if.then, %for.body121
  ...
  %arrayidx127 = getelementptr inbounds [260 x [240 x double]], [260 x [240 x double]]* @cov, i64 0, i64 %idxprom126, !taffo.initweight !14, !taffo.info !1
  ...
  %arrayidx129 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx127, i64 0, i64 %idxprom128, !taffo.initweight !15, !taffo.info !1
...
!13 = !{double 1.000000e+00, double 2.600000e+02}
!14 = !{i32 1}
!15 = !{i32 2}
!16 = !{i32 3}
!17 = !{i32 4}
