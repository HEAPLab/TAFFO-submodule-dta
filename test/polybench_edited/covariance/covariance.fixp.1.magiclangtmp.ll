...
@cov = common dso_local global [32 x [28 x double]] zeroinitializer, align 16
...
entry:
  ...
  call void @llvm.var.annotation(i8* %float_n1, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.2, i32 0, i32 0), i32 24)
  %i2 = bitcast i32* %i to i8*
  call void @llvm.var.annotation(i8* %i2, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.2, i32 0, i32 0), i32 28)
  %j3 = bitcast i32* %j to i8*
  call void @llvm.var.annotation(i8* %j3, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.2, i32 0, i32 0), i32 29)
  %k4 = bitcast i32* %k to i8*
  call void @llvm.var.annotation(i8* %k4, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.2, i32 0, i32 0), i32 30)
...
for.body9:                                        ; preds = %for.cond6
  ...
  %div = fdiv double %mul, 2.800000e+01
  ...
  %arrayidx13 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx, i64 0, i64 %idxprom12
...
for.cond17:                                       ; preds = %for.inc39, %for.end16
  ...
  %cmp18 = icmp slt i32 %9, 28
  br i1 %cmp18, label %for.body20, label %for.end41

for.body20:                                       ; preds = %for.cond17
  %10 = load i32, i32* %j, align 4
  %idxprom21 = sext i32 %10 to i64
  %arrayidx22 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom21
...
for.cond23:                                       ; preds = %for.inc33, %for.body20
  ...
  %cmp24 = icmp slt i32 %11, 32
  br i1 %cmp24, label %for.body26, label %for.end35

for.body26:                                       ; preds = %for.cond23
  %12 = load i32, i32* %i, align 4
  %idxprom27 = sext i32 %12 to i64
  %arrayidx28 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom27
  %13 = load i32, i32* %j, align 4
  %idxprom29 = sext i32 %13 to i64
  %arrayidx30 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx28, i64 0, i64 %idxprom29
  %14 = load double, double* %arrayidx30, align 8
  %15 = load i32, i32* %j, align 4
  %idxprom31 = sext i32 %15 to i64
  %arrayidx32 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom31
...
for.cond46:                                       ; preds = %for.inc56, %for.body45
  ...
  %cmp47 = icmp slt i32 %23, 28
  br i1 %cmp47, label %for.body49, label %for.end58

for.body49:                                       ; preds = %for.cond46
  %24 = load i32, i32* %j, align 4
  %idxprom50 = sext i32 %24 to i64
  %arrayidx51 = getelementptr inbounds [28 x double], [28 x double]* @mean, i64 0, i64 %idxprom50
...
for.cond66:                                       ; preds = %for.inc108, %for.body65
  ...
  %cmp67 = icmp slt i32 %33, 28
  br i1 %cmp67, label %for.body69, label %for.end110

for.body69:                                       ; preds = %for.cond66
  %34 = load i32, i32* %i, align 4
  %idxprom70 = sext i32 %34 to i64
  %arrayidx71 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @cov, i64 0, i64 %idxprom70
  %35 = load i32, i32* %j, align 4
  %idxprom72 = sext i32 %35 to i64
  %arrayidx73 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx71, i64 0, i64 %idxprom72
...
for.cond74:                                       ; preds = %for.inc92, %for.body69
  ...
  %cmp75 = icmp slt i32 %36, 32
  br i1 %cmp75, label %for.body77, label %for.end94

for.body77:                                       ; preds = %for.cond74
  %37 = load i32, i32* %k, align 4
  %idxprom78 = sext i32 %37 to i64
  %arrayidx79 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom78
  %38 = load i32, i32* %i, align 4
  %idxprom80 = sext i32 %38 to i64
  %arrayidx81 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx79, i64 0, i64 %idxprom80
  %39 = load double, double* %arrayidx81, align 8
  %40 = load i32, i32* %k, align 4
  %idxprom82 = sext i32 %40 to i64
  %arrayidx83 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @data, i64 0, i64 %idxprom82
  %41 = load i32, i32* %j, align 4
  %idxprom84 = sext i32 %41 to i64
  %arrayidx85 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx83, i64 0, i64 %idxprom84
  %42 = load double, double* %arrayidx85, align 8
  %mul86 = fmul double %39, %42
  %43 = load i32, i32* %i, align 4
  %idxprom87 = sext i32 %43 to i64
  %arrayidx88 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @cov, i64 0, i64 %idxprom87
  %44 = load i32, i32* %j, align 4
  %idxprom89 = sext i32 %44 to i64
  %arrayidx90 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx88, i64 0, i64 %idxprom89
...
for.end94:                                        ; preds = %for.cond74
  ...
  %arrayidx96 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @cov, i64 0, i64 %idxprom95
  %48 = load i32, i32* %j, align 4
  %idxprom97 = sext i32 %48 to i64
  %arrayidx98 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx96, i64 0, i64 %idxprom97
  %49 = load double, double* %arrayidx98, align 8
  %div99 = fdiv double %49, 3.100000e+01
  store double %div99, double* %arrayidx98, align 8
  %50 = load i32, i32* %i, align 4
  %idxprom100 = sext i32 %50 to i64
  %arrayidx101 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @cov, i64 0, i64 %idxprom100
  ...
  %arrayidx105 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @cov, i64 0, i64 %idxprom104
  %54 = load i32, i32* %i, align 4
  %idxprom106 = sext i32 %54 to i64
  %arrayidx107 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx105, i64 0, i64 %idxprom106
...
if.end:                                           ; preds = %if.then, %for.body121
  ...
  %arrayidx127 = getelementptr inbounds [32 x [28 x double]], [32 x [28 x double]]* @cov, i64 0, i64 %idxprom126
  %67 = load i32, i32* %j, align 4
  %idxprom128 = sext i32 %67 to i64
  %arrayidx129 = getelementptr inbounds [28 x double], [28 x double]* %arrayidx127, i64 0, i64 %idxprom128
